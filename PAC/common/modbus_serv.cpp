...
unsigned char ModbusServ::UTable[128][2] = {
    {0x4, 0x2},   {0x4, 0x3},   {0x20, 0x1A}, {0x4, 0x53},  {0x20, 0x1E},
    {0x20, 0x26}, {0x20, 0x20}, {0x20, 0x21}, {0x20, 0xAC}, {0x20, 0x30},
    {0x4, 0x9},   {0x20, 0x39}, {0x4, 0xA},   {0x4, 0xC},   {0x4, 0xB},
    {0x4, 0xF},   {0x4, 0x52},  {0x20, 0x18}, {0x20, 0x19}, {0x20, 0x1C},
    {0x20, 0x1D}, {0x20, 0x22}, {0x20, 0x13}, {0x20, 0x14}, {0x0, 0x0},
    {0x21, 0x22}, {0x4, 0x59},  {0x20, 0x3A}, {0x4, 0x5A},  {0x4, 0x5C},
    {0x4, 0x5B},  {0x4, 0x5F},  {0x0, 0xA0},  {0x4, 0xE},   {0x4, 0x5E},
    {0x4, 0x8},   {0x0, 0xA4},  {0x4, 0x90},  {0x0, 0xA6},  {0x0, 0xA7},
    {0x4, 0x1},   {0x0, 0xA9},  {0x4, 0x4},   {0x0, 0xAB},  {0x0, 0xAC},
    {0x0, 0xAD},  {0x0, 0xAE},  {0x4, 0x7},   {0x0, 0xB0},  {0x0, 0xB1},
    {0x4, 0x6},   {0x4, 0x56},  {0x4, 0x91},  {0x0, 0xB5},  {0x0, 0xB6},
    {0x0, 0xB7},  {0x4, 0x51},  {0x21, 0x16}, {0x4, 0x54},  {0x0, 0xBB},
    {0x4, 0x58},  {0x4, 0x5},   {0x4, 0x55},  {0x4, 0x57},  {0x4, 0x10},
    {0x4, 0x11},  {0x4, 0x12},  {0x4, 0x13},  {0x4, 0x14},  {0x4, 0x15},
    {0x4, 0x16},  {0x4, 0x17},  {0x4, 0x18},  {0x4, 0x19},  {0x4, 0x1A},
    {0x4, 0x1B},  {0x4, 0x1C},  {0x4, 0x1D},  {0x4, 0x1E},  {0x4, 0x1F},
    {0x4, 0x20},  {0x4, 0x21},  {0x4, 0x22},  {0x4, 0x23},  {0x4, 0x24},
    {0x4, 0x25},  {0x4, 0x26},  {0x4, 0x27},  {0x4, 0x28},  {0x4, 0x29},
    {0x4, 0x2A},  {0x4, 0x2B},  {0x4, 0x2C},  {0x4, 0x2D},  {0x4, 0x2E},
    {0x4, 0x2F},  {0x4, 0x30},  {0x4, 0x31},  {0x4, 0x32},  {0x4, 0x33},
    {0x4, 0x34},  {0x4, 0x35},  {0x4, 0x36},  {0x4, 0x37},  {0x4, 0x38},
    {0x4, 0x39},  {0x4, 0x3A},  {0x4, 0x3B},  {0x4, 0x3C},  {0x4, 0x3D},
    {0x4, 0x3E},  {0x4, 0x3F},  {0x4, 0x40},  {0x4, 0x41},  {0x4, 0x42},
    {0x4, 0x43},  {0x4, 0x44},  {0x4, 0x45},  {0x4, 0x46},  {0x4, 0x47},
    {0x4, 0x48},  {0x4, 0x49},  {0x4, 0x4A},  {0x4, 0x4B},  {0x4, 0x4C},
    {0x4, 0x4D},  {0x4, 0x4E},  {0x4, 0x4F}};
          ...
          switch (coilgroup) {
            ...
            case C_LINE9VALVES:
              ForceBit(i, &outdata[3],
                       get_device(coilgroup, objnumber)->get_state());
              break;
            case C_LS:
              ForceBit(i, &outdata[3],
                       get_device(coilgroup, objnumber)->is_active());
              break;
            case C_OTHER:
              ...
              switch (objnumber) {
                ...
                case OTHER_SWITCH4:
                  ForceBit(i, &outdata[3],
                           cipline_tech_object::Mdls[line - 1]->getSwitch(
                               objnumber + 1 - OTHER_SWITCH1));
                  break;
              }
              break;
            case C_MSA_STATIONPARAMS:
              ForceBit(
                  i, &outdata[3],
                  cipline_tech_object::Mdls[0]->get_station_par(objnumber) != 0
                      ? 1
                      : 0);
              break;
            case C_MSA_CONTROL:
              ...
              if (line <= (unsigned int)cipline_tech_object::MdlsCNT) {
                switch (objnumber) {
                  case RETPUMP_STATE:
                    ForceBit(
                        i, &outdata[3],
                        cipline_tech_object::Mdls[line - 1]->GetRetState());
                    break;
                  case RETPUMP_ISUSED:
                    ForceBit(i, &outdata[3],
                             cipline_tech_object::Mdls[line - 1]->HasRet());
                    break;
                }
              }
              break;
            ...
            case C_MSA_LINE9PARAMS:
              if (coilgroup - C_MSA_LINE1PARAMS <
                  (unsigned int)cipline_tech_object::MdlsCNT) {
                ForceBit(
                    i, &outdata[3],
                    cipline_tech_object::Mdls[coilgroup - C_MSA_LINE1PARAMS]
                                ->rt_par_float[objnumber - 1] != 0
                        ? 1
                        : 0);
              }
              break;
    ...
    case 0x03:  // Read Holding Registers
    {
      ...
      if (isMsa) {
        ...
        for (i = 0; i < numberofElements; i++) {
          ...
          switch (coilgroup) {
            case C_AO:
              PackFloat(get_device(coilgroup, objnumber)->get_value(),
                        &outdata[3 + i * 2]);
              i++;
              break;
            case C_FE:
              if (objnumber > 0) {
                PackFloat(
                    ((i_counter*)get_device(coilgroup, objnumber))->get_flow(),
                    &outdata[3 + i * 2]);
              }
              i++;
              break;
            case C_CTR:
              if (objnumber > 0) {
                PackFloat((float)((i_counter*)get_device(coilgroup, objnumber))
                              ->get_quantity(),
                          &outdata[3 + i * 2]);
              }
              i++;
            ...
            case C_OTHER:
              ...
              switch (objnumber) {
                case OTHER_CARNO1:
                  Utf8toUnicode(cipline_tech_object::Mdls[line - 1]->ncar1,
                                &outdata[3 + i * 2]);
                  i += CAR_NAME_MAX_LENGTH;
                  break;
                case OTHER_CARNO2:
                  Utf8toUnicode(cipline_tech_object::Mdls[line - 1]->ncar2,
                                &outdata[3 + i * 2]);
                  i += CAR_NAME_MAX_LENGTH;
                  break;
                case OTHER_CARNO3:
                  Utf8toUnicode(cipline_tech_object::Mdls[line - 1]->ncar3,
                                &outdata[3 + i * 2]);
                  i += CAR_NAME_MAX_LENGTH;
                  break;
                case OTHER_CARNO4:
                  Utf8toUnicode(cipline_tech_object::Mdls[line - 1]->ncar4,
                                &outdata[3 + i * 2]);
                  i += CAR_NAME_MAX_LENGTH;
                  break;
                case OTHER_CAUSTIC_COUNT:
                  PackInt16(cipline_tech_object::Mdls[line - 1]
                                ->objectstats->objcausticwashes,
                            &outdata[3 + i * 2]);
                  break;
                case OTHER_LAST_ACID_WASH:
                  Utf8toUnicode(cipline_tech_object::Mdls[line - 1]
            ...
            case C_MSA_RECIPES:
              ...
              switch (objnumber) {
                ...
                case RC_RECIPE_CONTROL_NO:
                  PackInt16(int_2(cipline_tech_object::Mdls[line - 1]
                                      ->rt_par_float[P_CUR_REC]),
                            &outdata[3 + i * 2]);
                  break;
                case RC_SELECTED_REC:
                  Utf8toUnicode(
                      cipline_tech_object::Mdls[line - 1]->loadedRecName,
                      &outdata[3 + i * 2]);
                  i += TRecipeManager::recipeNameLength - 1;
                  break;
                case RC_SELECTED_PRG:
                  Utf8toUnicode(
                      cipline_tech_object::Mdls[line - 1]->currentProgramName,
                      &outdata[3 + i * 2]);
                  i += PROGRAM_MAX_LEN - 1;
                  break;
                case RC_EDITED_REC:
                ...
                case RC_LIST_LENGTH:
                  k = 0;
                  for (j = 0; j < u_int(cipline_tech_object::Mdls[line - 1]
                                            ->lineRecipes->recipePerLine);
                       j++) {
                    if (1 == cipline_tech_object::Mdls[line - 1]
                                 ->lineRecipes->getRecipeValue(
                                     j, TRecipeManager::RV_IS_USED)) {
                      k++;
                    }
                  }
                ...
                case RC_PRG_UPDATE:
                  ...
                  break;
                case RC_PRG_LENGTH:
                  PackInt16(cipline_tech_object::Mdls[line - 1]->prgListLen,
                            &outdata[3 + i * 2]);
                  break;
                default:
                  if (objnumber >= RC_LIST_START && objnumber < RC_PRG_SELECT) {
                    int recipeno = (objnumber - RC_LIST_START) /
                                   TRecipeManager::recipeNameLength;
                    //								printf("\n\rRecipeNo = %d",
                    //recipeno);
                    k = -1;
                    for (j = 0; j < u_int(cipline_tech_object::Mdls[line - 1]
                      ...
                      if (k == recipeno) {
                        ...
                        cipline_tech_object::Mdls[line - 1]
                            ->lineRecipes->getRecipeName(j, myrec);
                    ...
                    if (objnumber >= RC_PRG_START &&
                        objnumber < RC_RECIPE_PAR_START) {
                      unsigned int prgno =
                          (objnumber - RC_PRG_START) / PROGRAM_MAX_LEN;
                      if (prgno <
                          cipline_tech_object::Mdls[line - 1]->prgArray.size())
                        Utf8toUnicode(cipline_tech_object::Mdls[line - 1]
                                          ->prgArray[prgno]
                                          .data(),
                                      &outdata[3 + i * 2]);
                      ...
                      if (objnumber >= RC_RECIPE_PAR_START) {
                        ...
                        if (k < cipline_tech_object::Mdls[line - 1]
                                    ->lineRecipes->GetParamsCount()) {
                          PackFloat(cipline_tech_object::Mdls[line - 1]
                                        ->lineRecipes->getValue(k - 1),
                                    &outdata[3 + i * 2]);
                          i++;
                        }
                      } else {
            ...
            case C_MSA_STATIONPARAMS:
              PackFloat(
                  cipline_tech_object::Mdls[0]->get_station_par(objnumber / 2),
                  &outdata[3 + i * 2]);
              i++;
              break;
              ...
              if (line < (unsigned int)cipline_tech_object::MdlsCNT) {
                switch (objnumber) {
                  case MSACTRL_OPERATION:
                    PackInt16(cipline_tech_object::Mdls[line]->curstep,
                              &outdata[3 + i * 2]);
                    break;
                  case MSACTRL_STATE:
                  ...
                  case MSACTRL_RETTEMP:
                    PackFloat(cipline_tech_object::Mdls[line]
                                      ->rt_par_float[P_ZAD_PODOGR] -
                                  cipline_tech_object::Mdls[line]
                                      ->rt_par_float[P_DELTA_TR],
                              &outdata[3 + i * 2]);
                    i++;
                    break;
                  case MSACTRL_MSANUMBER:
                    PackInt16(cipline_tech_object::msa_number,
                              &outdata[3 + i * 2]);
                    break;
                  default:
                    break;
      ...
      luareadregisters:
        ...
        if (has_Lua_read_holding_registers == 0) {
          ...
          lua_remove(L,
                     -1);  // Stack: remove function "read_holding_registers".
        }
        ...
        switch (coilgroup) {
          ...
          case C_OTHER:
            ...
            switch (objnumber) {
              ...
              case OTHER_SWITCH3:
              case OTHER_SWITCH4:
                cipline_tech_object::Mdls[line - 1]->setSwitch(
                    objnumber + 1 - OTHER_SWITCH1, data[4] ? ON : OFF);
                break;
            }
            break;
          case C_MSA_STATIONPARAMS:
            if (objnumber < cipline_tech_object::Mdls[0]->parpar->get_count()) {
              cipline_tech_object::Mdls[0]->set_station_par(
                  objnumber, (float)(data[4] ? 1 : 0));
            }
            break;
          case C_MSA_LINE1PARAMS:
          case C_MSA_LINE2PARAMS:
          ...
          case C_MSA_LINE9PARAMS:
            if (coilgroup - C_MSA_LINE1PARAMS <
                (unsigned int)cipline_tech_object::MdlsCNT) {
              if (cipline_tech_object::Mdls[coilgroup - C_MSA_LINE1PARAMS]
                      ->rt_par_float.get_count() >= objnumber) {
                cipline_tech_object::Mdls[coilgroup - C_MSA_LINE1PARAMS]
                    ->rt_par_float[objnumber - 1] = (float)(data[4] ? 1 : 0);
              }
            }
            break;
          default:
    ...
    case 0x10:  // Force Multiply Registers
    {
      ...
      if (isMsa) {
        for (i = 0; i < numberofElements; i++) {
          ...
          switch (coilgroup) {
            case C_AO:
              get_device(coilgroup, objnumber)
                  ->set_value(UnpackFloat(&data[7 + i * 2]));
              i++;
              break;
            case C_OTHER:
              line = (i + startingAddress) / 1000;
              ...
              switch (objnumber) {
                case OTHER_CARNO1:
                  if (cipline_tech_object::Mdls[line - 1]->state == 0) {
                    UnicodetoUtf8(cipline_tech_object::Mdls[line - 1]->ncar1,
                                  &data[7 + i * 2], 15);
                    cipline_tech_object::Mdls[line - 1]->objectstats =
                        cipline_tech_object::statsbase->stats_if_exists(
                            cipline_tech_object::Mdls[line - 1]->ncar1,
                            cipline_tech_object::Mdls[line - 1]->emptystats);
                  }
                  i += CAR_NAME_MAX_LENGTH;
                  break;
                case OTHER_CARNO2:
                  UnicodetoUtf8(cipline_tech_object::Mdls[line - 1]->ncar2,
                                &data[7 + i * 2], 15);
                  i += CAR_NAME_MAX_LENGTH;
                  break;
                case OTHER_CARNO3:
                  UnicodetoUtf8(cipline_tech_object::Mdls[line - 1]->ncar3,
                                &data[7 + i * 2], 15);
                  i += CAR_NAME_MAX_LENGTH;
                  break;
                case OTHER_CARNO4:
                  UnicodetoUtf8(cipline_tech_object::Mdls[line - 1]->ncar4,
                                &data[7 + i * 2], 15);
                  i += CAR_NAME_MAX_LENGTH;
                  break;
                default:
              ...
              switch (objnumber) {
                case RC_RECIPE_CONTROL:
                  ...
                  if (1 == k) {
                    ...
                    cipline_tech_object::Mdls[line - 1]
                        ->rt_par_float[P_CUR_REC] =
                        (float)(cipline_tech_object::Mdls[line - 1]
                                    ->lineRecipes->getCurrentRecipe() +
                                1);
                  }
                  if (2 == k) {
                    cipline_tech_object::Mdls[line - 1]
                ...
                case RC_RECIPE_CONTROL_NO:
                  k = UnpackInt16(&data[7 + i * 2]);
                  cipline_tech_object::Mdls[line - 1]->rt_par_float[P_CUR_REC] =
                      (float)k;
                  break;
                case RC_SELECT_REC:
                  ...
                  k = -1;
                  for (j = 0;
                       j < (unsigned int)(cipline_tech_object::Mdls[line - 1]
                                              ->lineRecipes->recipePerLine);
                       j++) {
                    if (1 == cipline_tech_object::Mdls[line - 1]
                                 ->lineRecipes->getRecipeValue(
                    ...
                    if (k == recipe_to_load &&
                        cipline_tech_object::Mdls[line - 1]->state == 0) {
                      cipline_tech_object::Mdls[line - 1]
                          ->rt_par_float[P_SELECT_REC] = (float)(j + 1);
                      break;
                    }
                  }
                  break;
                case RC_EDITED_REC:
                  ...
                  UnicodetoUtf8(cipline_tech_object::Mdls[line - 1]
                                    ->lineRecipes->currentRecipeName,
                                &data[7 + i * 2], 24);
                  i += cipline_tech_object::Mdls[line - 1]
                           ->lineRecipes->recipeNameLength -
                       1;
                  break;
                case RC_LIST_UPDATE:
                  k = UnpackInt16(&data[7 + i * 2]);
                ...
                default:
                  if (objnumber >= RC_RECIPE_PAR_START) {
                    ...
                    if (k <= cipline_tech_object::Mdls[line - 1]
                                 ->lineRecipes->GetParamsCount()) {
                      cipline_tech_object::Mdls[line - 1]
                          ->lineRecipes->setValue(
                              k - 1, UnpackFloat(&data[7 + i * 2]));
                      i++;
                    }
                  }
                  break;
            ...
            case C_MSA_STATIONPARAMS:
              if ((objnumber / 2) <=
                  cipline_tech_object::Mdls[0]->parpar->get_count()) {
                if (G_DEBUG) {
                  printf("\n\rWrite Station param %d = %f", objnumber / 2,
                         UnpackFloat(&data[7 + i * 2]));
                }
                cipline_tech_object::Mdls[0]->set_station_par(
                    objnumber / 2, UnpackFloat(&data[7 + i * 2]));
              }
              i++;
              break;
            case C_MSA_CONTROL:
            ...
            case C_MSA_LINE9PARAMS:
              if (coilgroup - C_MSA_LINE1PARAMS <
                  (unsigned int)(cipline_tech_object::MdlsCNT)) {
                if (cipline_tech_object::Mdls[coilgroup - C_MSA_LINE1PARAMS]
                        ->rt_par_float.get_count() >= objnumber / 2) {
                  cipline_tech_object::Mdls[coilgroup - C_MSA_LINE1PARAMS]
                      ->rt_par_float[objnumber / 2] =
                      UnpackFloat(&data[7 + i * 2]);
                }
      ...
      luawriteregisters:
        ...
        if (has_Lua_write_registers == 0) {
          ...
          lua_remove(L,
                     -1);  // Stack: remove function "write_holding_registers".
        }
...
int ModbusServ::PackTime(unsigned long timevar, unsigned char* Buf,
                         int units /*= 0*/) {
...
int ModbusServ::UnicodetoCP1251(char* Output, unsigned char* Buf,
                                int inputlen) {
  int i;
...
device* ModbusServ::get_device(unsigned int group, unsigned int number) {
  ...
  switch (group) {
    ...
    case C_LINE9VALVES:
      ...
      if (line > 0 && line <= (unsigned int)cipline_tech_object::MdlsCNT &&
          (number == 1001 || number == 1002 || 1004 == number ||
           1006 == number ||
           (number / 1000 == 1 && (number - 1000) % 10 <= 2 &&
            (number - 1000) / 10 <= 4))) {
        sprintf(devname, "LINE%dV%d", line, number);
        ret = (device*)V(devname);
      }
