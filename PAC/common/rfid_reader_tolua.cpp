...
static int tolua_get_EPC_info_EPC_str(lua_State* tolua_S) {
  ...
  if (!self)
    tolua_error(tolua_S, "invalid 'self' in accessing variable 'EPC_str'",
                NULL);
#endif
...
#ifndef TOLUA_RELEASE
  if (!self)
    tolua_error(tolua_S, "invalid 'self' in accessing variable 'antenna'",
                NULL);
#endif
...
#ifndef TOLUA_RELEASE
  if (!self)
    tolua_error(tolua_S, "invalid 'self' in accessing variable 'RSSI'", NULL);
#endif
...
static int tolua_rfid_reader_rfid_reader_add_reader00(lua_State* tolua_S) {
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!tolua_isusertable(tolua_S, 1, "rfid_reader", 0, &tolua_err) ||
...
#endif
  {
    ...
    {
      rfid_reader* tolua_ret =
          (rfid_reader*)rfid_reader::add_reader(ip_address, number);
...
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!tolua_isusertype(tolua_S, 1, "rfid_reader", 0, &tolua_err) ||
...
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!tolua_isusertype(tolua_S, 1, "const rfid_reader", 0, &tolua_err) ||
...
#endif
  {
    const rfid_reader* self =
        (const rfid_reader*)tolua_tousertype(tolua_S, 1, 0);
    int idx = ((int)tolua_tonumber(tolua_S, 2, 0));
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'get_EPC_info'", NULL);
#endif
    {
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'get_EPC_cnt'", NULL);
#endif
    {
...
TOLUA_API int tolua_rfid_reader_open(lua_State* tolua_S) {
  ...
  tolua_variable(tolua_S, "EPC_str", tolua_get_EPC_info_EPC_str,
                 tolua_set_EPC_info_EPC_str);
  tolua_variable(tolua_S, "antenna", tolua_get_EPC_info_antenna,
                 tolua_set_EPC_info_antenna);
  tolua_variable(tolua_S, "RSSI", tolua_get_EPC_info_RSSI,
                 tolua_set_EPC_info_RSSI);
  ...
  tolua_function(tolua_S, "add_reader",
                 tolua_rfid_reader_rfid_reader_add_reader00);
  tolua_function(tolua_S, "evaluate", tolua_rfid_reader_rfid_reader_evaluate00);
  tolua_function(tolua_S, "get_EPC_info",
                 tolua_rfid_reader_rfid_reader_get_EPC_info00);
  tolua_function(tolua_S, "get_EPC_cnt",
                 tolua_rfid_reader_rfid_reader_get_EPC_cnt00);
  tolua_endmodule(tolua_S);
  tolua_endmodule(tolua_S);
  return 1;
}
