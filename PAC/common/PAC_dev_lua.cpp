...
static int tolua_collect_cipline_tech_object(lua_State* tolua_S) {
  cipline_tech_object* self =
      (cipline_tech_object*)tolua_tousertype(tolua_S, 1, 0);
  Mtolua_delete(self);
  return 0;
}
...
static int tolua_PAC_dev_i_DI_device_get_state00(lua_State* tolua_S) {
  ...
  if (!tolua_isusertype(tolua_S, 1, "i_DI_device", 0, &tolua_err) ||
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'get_state'", NULL);
#endif
    {
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'is_active'", NULL);
#endif
    {
...
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!tolua_isusertype(tolua_S, 1, "i_DO_device", 0, &tolua_err) ||
      !tolua_isnoobj(tolua_S, 2, &tolua_err))
    goto tolua_lerror;
  else
#endif
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'instant_off'", NULL);
#endif
    { self->instant_off(); }
  }
  return 0;
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'set_state'", NULL);
#endif
...
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!tolua_isusertype(tolua_S, 1, "i_AI_device", 0, &tolua_err) ||
      !tolua_isnoobj(tolua_S, 2, &tolua_err))
    goto tolua_lerror;
  else
#endif
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'get_value'", NULL);
#endif
    {
...
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!tolua_isusertype(tolua_S, 1, "i_AO_device", 0, &tolua_err) ||
      !tolua_isnoobj(tolua_S, 2, &tolua_err))
    goto tolua_lerror;
  else
#endif
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'set_value'", NULL);
#endif
...
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!tolua_isusertype(tolua_S, 1, "i_DO_AO_device", 0, &tolua_err) ||
      !tolua_isnoobj(tolua_S, 2, &tolua_err))
    goto tolua_lerror;
  else
#endif
...
static int tolua_get_i_DO_AO_device___i_AO_device__(lua_State* tolua_S) {
  ...
  if (!self)
    tolua_error(tolua_S,
                "invalid 'self' in accessing variable '__i_AO_device__'", NULL);
#endif
#ifdef __cplusplus
  tolua_pushusertype(tolua_S, (void*)static_cast<i_AO_device*>(self),
                     "i_AO_device");
#else
...
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!tolua_isusertype(tolua_S, 1, "i_counter", 0, &tolua_err) ||
      !tolua_isnoobj(tolua_S, 2, &tolua_err))
    goto tolua_lerror;
  else
#endif
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'restart'", NULL);
#endif
    { self->restart(); }
  }
  return 0;
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'get_quantity'", NULL);
#endif
    {
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'get_flow'", NULL);
#endif
    {
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'get_abs_quantity'",
                  NULL);
#endif
    {
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'abs_reset'", NULL);
#endif
    { self->abs_reset(); }
  }
  return 0;
...
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!tolua_isusertype(tolua_S, 1, "device", 0, &tolua_err) ||
      !tolua_isnoobj(tolua_S, 2, &tolua_err))
    goto tolua_lerror;
  else
#endif
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'set_cmd'", NULL);
#endif
    {
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'set_par'", NULL);
#endif
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'set_rt_par'", NULL);
#endif
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'set_property'", NULL);
#endif
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'set_string_property'",
                  NULL);
#endif
...
#ifndef TOLUA_RELEASE
tolua_lerror:
  tolua_error(tolua_S, "#ferror in function 'set_string_property'.",
              &tolua_err);
  return 0;
#endif
}
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'set_descr'", NULL);
#endif
...
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!tolua_isusertype(tolua_S, 1, "const device", 0, &tolua_err) ||
      !tolua_isnoobj(tolua_S, 2, &tolua_err))
    goto tolua_lerror;
  else
#endif
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'get_type_str'", NULL);
#endif
    {
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'param_emulator'", NULL);
#endif
...
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!tolua_isusertype(tolua_S, 1, "i_wages", 0, &tolua_err) ||
      !tolua_isnoobj(tolua_S, 2, &tolua_err))
    goto tolua_lerror;
  else
#endif
...
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!tolua_isusertype(tolua_S, 1, "i_motor", 0, &tolua_err) ||
      !tolua_isnoobj(tolua_S, 2, &tolua_err))
    goto tolua_lerror;
  else
#endif
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'reverse'", NULL);
#endif
    { self->reverse(); }
  }
  return 0;
...
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!tolua_isusertype(tolua_S, 1, "const i_motor", 0, &tolua_err) ||
      !tolua_isnoobj(tolua_S, 2, &tolua_err))
    goto tolua_lerror;
  else
#endif
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'get_linear_speed'",
                  NULL);
#endif
    {
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'get_amperage'", NULL);
#endif
    {
...
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!tolua_isusertype(tolua_S, 1, "signal_column", 0, &tolua_err) ||
      !tolua_isnoobj(tolua_S, 2, &tolua_err))
    goto tolua_lerror;
  else
#endif
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'turn_off_red'", NULL);
#endif
    { self->turn_off_red(); }
  }
  return 0;
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'turn_off_yellow'",
                  NULL);
#endif
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'turn_off_green'", NULL);
#endif
    { self->turn_off_green(); }
  }
  return 0;
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'turn_off_blue'", NULL);
#endif
    { self->turn_off_blue(); }
  }
  return 0;
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'turn_on_red'", NULL);
#endif
    { self->turn_on_red(); }
  }
  return 0;
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'turn_on_yellow'", NULL);
#endif
    { self->turn_on_yellow(); }
  }
  return 0;
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'turn_on_green'", NULL);
#endif
    { self->turn_on_green(); }
  }
  return 0;
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'turn_on_blue'", NULL);
#endif
    { self->turn_on_blue(); }
  }
  return 0;
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'normal_blink_red'",
                  NULL);
#endif
...
static int tolua_PAC_dev_signal_column_normal_blink_yellow00(
    lua_State* tolua_S) {
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!tolua_isusertype(tolua_S, 1, "signal_column", 0, &tolua_err) ||
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'normal_blink_yellow'",
                  NULL);
#endif
...
#ifndef TOLUA_RELEASE
tolua_lerror:
  tolua_error(tolua_S, "#ferror in function 'normal_blink_yellow'.",
              &tolua_err);
  return 0;
#endif
}
...
static int tolua_PAC_dev_signal_column_normal_blink_green00(
    lua_State* tolua_S) {
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!tolua_isusertype(tolua_S, 1, "signal_column", 0, &tolua_err) ||
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'normal_blink_green'",
                  NULL);
#endif
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'normal_blink_blue'",
                  NULL);
#endif
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'slow_blink_red'", NULL);
#endif
    { self->slow_blink_red(); }
  }
  return 0;
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'slow_blink_yellow'",
                  NULL);
#endif
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'slow_blink_green'",
                  NULL);
#endif
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'slow_blink_blue'",
                  NULL);
#endif
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'turn_on_siren'", NULL);
#endif
    { self->turn_on_siren(); }
  }
  return 0;
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'turn_off_siren'", NULL);
#endif
    { self->turn_off_siren(); }
  }
  return 0;
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'show_error_exists'",
                  NULL);
#endif
...
static int tolua_PAC_dev_signal_column_show_message_exists00(
    lua_State* tolua_S) {
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!tolua_isusertype(tolua_S, 1, "signal_column", 0, &tolua_err) ||
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'show_message_exists'",
                  NULL);
#endif
...
#ifndef TOLUA_RELEASE
tolua_lerror:
  tolua_error(tolua_S, "#ferror in function 'show_message_exists'.",
              &tolua_err);
  return 0;
#endif
}
...
static int tolua_PAC_dev_signal_column_show_batch_is_not_running00(
    lua_State* tolua_S) {
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!tolua_isusertype(tolua_S, 1, "signal_column", 0, &tolua_err) ||
...
#endif
  {
    ...
    if (!self)
      tolua_error(tolua_S,
                  "invalid 'self' in function 'show_batch_is_not_running'",
                  NULL);
#endif
...
#ifndef TOLUA_RELEASE
tolua_lerror:
  tolua_error(tolua_S, "#ferror in function 'show_batch_is_not_running'.",
              &tolua_err);
  return 0;
#endif
}
...
static int tolua_PAC_dev_signal_column_show_batch_is_running00(
    lua_State* tolua_S) {
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!tolua_isusertype(tolua_S, 1, "signal_column", 0, &tolua_err) ||
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'show_batch_is_running'",
                  NULL);
#endif
...
#ifndef TOLUA_RELEASE
tolua_lerror:
  tolua_error(tolua_S, "#ferror in function 'show_batch_is_running'.",
              &tolua_err);
  return 0;
#endif
}
...
static int tolua_PAC_dev_signal_column_show_operation_is_not_running00(
    lua_State* tolua_S) {
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!tolua_isusertype(tolua_S, 1, "signal_column", 0, &tolua_err) ||
...
#endif
  {
    ...
    if (!self)
      tolua_error(tolua_S,
                  "invalid 'self' in function 'show_operation_is_not_running'",
                  NULL);
#endif
...
#ifndef TOLUA_RELEASE
tolua_lerror:
  tolua_error(tolua_S, "#ferror in function 'show_operation_is_not_running'.",
              &tolua_err);
  return 0;
#endif
}
...
static int tolua_PAC_dev_signal_column_show_operation_is_running00(
    lua_State* tolua_S) {
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!tolua_isusertype(tolua_S, 1, "signal_column", 0, &tolua_err) ||
...
#endif
  {
    ...
    if (!self)
      tolua_error(tolua_S,
                  "invalid 'self' in function 'show_operation_is_running'",
                  NULL);
#endif
...
#ifndef TOLUA_RELEASE
tolua_lerror:
  tolua_error(tolua_S, "#ferror in function 'show_operation_is_running'.",
              &tolua_err);
  return 0;
#endif
}
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'show_idle'", NULL);
#endif
    { self->show_idle(); }
  }
  return 0;
...
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!tolua_isusertype(tolua_S, 1, "dev_stub", 0, &tolua_err) ||
      !tolua_isnoobj(tolua_S, 2, &tolua_err))
    goto tolua_lerror;
  else
#endif
...
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!tolua_isusertable(tolua_S, 1, "errors_manager", 0, &tolua_err) ||
      !tolua_isnoobj(tolua_S, 2, &tolua_err))
    goto tolua_lerror;
  else
#endif
...
static int tolua_PAC_dev_errors_manager_set_cmd00(lua_State* tolua_S) {
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!tolua_isusertype(tolua_S, 1, "errors_manager", 0, &tolua_err) ||
      !tolua_isnumber(tolua_S, 2, 0, &tolua_err) ||
      !tolua_isnumber(tolua_S, 3, 0, &tolua_err) ||
      !tolua_isnumber(tolua_S, 4, 0, &tolua_err) ||
...
#endif
  {
    ...
    unsigned int object_alarm_number =
        ((unsigned int)tolua_tonumber(tolua_S, 5, 0));
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'set_cmd'", NULL);
#endif
...
static int tolua_PAC_dev_dev_errors_manager_get_instance00(lua_State* tolua_S) {
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!tolua_isusertable(tolua_S, 1, "dev_errors_manager", 0, &tolua_err) ||
      !tolua_isnoobj(tolua_S, 2, &tolua_err))
    goto tolua_lerror;
  else
#endif
  {
    {
      errors_manager* tolua_ret =
          (errors_manager*)dev_errors_manager::get_instance();
      tolua_pushusertype(tolua_S, (void*)tolua_ret, "errors_manager");
    }
  }
  return 1;
...
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!tolua_isusertype(tolua_S, 1, "dev_errors_manager", 0, &tolua_err) ||
      !tolua_isnumber(tolua_S, 2, 0, &tolua_err) ||
      !tolua_isnumber(tolua_S, 3, 0, &tolua_err) ||
      !tolua_isnumber(tolua_S, 4, 0, &tolua_err) ||
      !tolua_isnumber(tolua_S, 5, 0, &tolua_err) ||
...
#endif
  {
    dev_errors_manager* self =
        (dev_errors_manager*)tolua_tousertype(tolua_S, 1, 0);
    unsigned int cmd = ((unsigned int)tolua_tonumber(tolua_S, 2, 0));
    unsigned int object_type = ((unsigned int)tolua_tonumber(tolua_S, 3, 0));
    unsigned int object_number = ((unsigned int)tolua_tonumber(tolua_S, 4, 0));
    unsigned int object_alarm_number =
...
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!tolua_isusertype(tolua_S, 1, "valve", 0, &tolua_err) ||
      !tolua_isnoobj(tolua_S, 2, &tolua_err))
    goto tolua_lerror;
  else
#endif
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'is_opened'", NULL);
#endif
    {
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'is_closed'", NULL);
#endif
    {
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'get_on_fb_value'",
                  NULL);
#endif
    {
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'get_off_fb_value'",
                  NULL);
#endif
    {
...
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!tolua_isusertype(tolua_S, 1, "level", 0, &tolua_err) ||
      !tolua_isnoobj(tolua_S, 2, &tolua_err))
    goto tolua_lerror;
  else
#endif
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'get_volume'", NULL);
#endif
    {
...
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!tolua_isusertype(tolua_S, 1, "virtual_counter", 0, &tolua_err) ||
      !tolua_isnoobj(tolua_S, 2, &tolua_err))
    goto tolua_lerror;
  else
#endif
...
static int tolua_PAC_dev_virtual_counter_get_abs_quantity00(
    lua_State* tolua_S) {
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!tolua_isusertype(tolua_S, 1, "virtual_counter", 0, &tolua_err) ||
...
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!tolua_isusertype(tolua_S, 1, "tech_object", 0, &tolua_err) ||
      !tolua_isstring(tolua_S, 2, 0, &tolua_err) ||
      !tolua_isnumber(tolua_S, 3, 0, &tolua_err) ||
      !tolua_isnumber(tolua_S, 4, 0, &tolua_err) ||
      !tolua_isnoobj(tolua_S, 5, &tolua_err))
...
static int tolua_PAC_dev_tech_object_new00(lua_State* tolua_S) {
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!tolua_isusertable(tolua_S, 1, "tech_object", 0, &tolua_err) ||
      !tolua_isstring(tolua_S, 2, 0, &tolua_err) ||
      !tolua_isnumber(tolua_S, 3, 0, &tolua_err) ||
      !tolua_isnumber(tolua_S, 4, 0, &tolua_err) ||
...
#endif
  {
    ...
    unsigned int par_float_count =
        ((unsigned int)tolua_tonumber(tolua_S, 8, 0));
    unsigned int runtime_par_float_count =
        ((unsigned int)tolua_tonumber(tolua_S, 9, 0));
    unsigned int par_uint_count =
        ((unsigned int)tolua_tonumber(tolua_S, 10, 0));
    unsigned int runtime_par_uint_count =
        ((unsigned int)tolua_tonumber(tolua_S, 11, 0));
    {
      tech_object* tolua_ret = (tech_object*)Mtolua_new(
          (tech_object)(name, number, type, name_Lua, states_count,
                        timers_count, par_float_count, runtime_par_float_count,
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'set_mode'", NULL);
#endif
    {
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'get_mode'", NULL);
#endif
    {
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'get_operation_state'",
                  NULL);
#endif
    {
...
#ifndef TOLUA_RELEASE
tolua_lerror:
  tolua_error(tolua_S, "#ferror in function 'get_operation_state'.",
              &tolua_err);
  return 0;
#endif
}
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'exec_cmd'", NULL);
#endif
    {
...
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!tolua_isusertype(tolua_S, 1, "const tech_object", 0, &tolua_err) ||
      !tolua_isnoobj(tolua_S, 2, &tolua_err))
    goto tolua_lerror;
  else
#endif
  {
    const tech_object* self =
        (const tech_object*)tolua_tousertype(tolua_S, 1, 0);
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'get_modes_count'",
                  NULL);
#endif
    {
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'check_operation_on'",
                  NULL);
#endif
    {
...
#ifndef TOLUA_RELEASE
  if (!self)
    tolua_error(tolua_S, "invalid 'self' in accessing variable 'par_float'",
                NULL);
#endif
...
static int tolua_set_tech_object_par_float(lua_State* tolua_S) {
  ...
  if ((tolua_isvaluenil(tolua_S, 2, &tolua_err) ||
       !tolua_isusertype(tolua_S, 2, "saved_params_float", 0, &tolua_err)))
...
#ifndef TOLUA_RELEASE
  if (!self)
    tolua_error(tolua_S, "invalid 'self' in accessing variable 'rt_par_float'",
                NULL);
#endif
  tolua_pushusertype(tolua_S, (void*)&self->rt_par_float,
                     "run_time_params_float");
  return 1;
}
#endif  //#ifndef TOLUA_DISABLE
...
static int tolua_set_tech_object_rt_par_float(lua_State* tolua_S) {
  ...
  if (!self)
    tolua_error(tolua_S, "invalid 'self' in accessing variable 'rt_par_float'",
                NULL);
  if ((tolua_isvaluenil(tolua_S, 2, &tolua_err) ||
       !tolua_isusertype(tolua_S, 2, "run_time_params_float", 0, &tolua_err)))
    tolua_error(tolua_S, "#vinvalid type in variable assignment.", &tolua_err);
#endif
  self->rt_par_float =
      *((run_time_params_float*)tolua_tousertype(tolua_S, 2, 0));
  return 0;
}
#endif  //#ifndef TOLUA_DISABLE
...
#ifndef TOLUA_RELEASE
  if (!self)
    tolua_error(tolua_S, "invalid 'self' in accessing variable 'par_uint'",
                NULL);
#endif
...
static int tolua_set_tech_object_par_uint(lua_State* tolua_S) {
  ...
  if (!self)
    tolua_error(tolua_S, "invalid 'self' in accessing variable 'par_uint'",
                NULL);
  if ((tolua_isvaluenil(tolua_S, 2, &tolua_err) ||
       !tolua_isusertype(tolua_S, 2, "saved_params_u_int_4", 0, &tolua_err)))
    tolua_error(tolua_S, "#vinvalid type in variable assignment.", &tolua_err);
#endif
...
#ifndef TOLUA_RELEASE
  if (!self)
    tolua_error(tolua_S, "invalid 'self' in accessing variable 'rt_par_uint'",
                NULL);
#endif
  tolua_pushusertype(tolua_S, (void*)&self->rt_par_uint,
                     "run_time_params_u_int_4");
  return 1;
}
#endif  //#ifndef TOLUA_DISABLE
...
static int tolua_set_tech_object_rt_par_uint(lua_State* tolua_S) {
  ...
  if (!self)
    tolua_error(tolua_S, "invalid 'self' in accessing variable 'rt_par_uint'",
                NULL);
  if ((tolua_isvaluenil(tolua_S, 2, &tolua_err) ||
       !tolua_isusertype(tolua_S, 2, "run_time_params_u_int_4", 0, &tolua_err)))
    tolua_error(tolua_S, "#vinvalid type in variable assignment.", &tolua_err);
#endif
  self->rt_par_uint =
      *((run_time_params_u_int_4*)tolua_tousertype(tolua_S, 2, 0));
  return 0;
}
#endif  //#ifndef TOLUA_DISABLE
...
#ifndef TOLUA_RELEASE
  if (!self)
    tolua_error(tolua_S, "invalid 'self' in accessing variable 'timers'", NULL);
#endif
...
static int tolua_set_tech_object_timers(lua_State* tolua_S) {
  ...
  if (!self)
    tolua_error(tolua_S, "invalid 'self' in accessing variable 'timers'", NULL);
  if ((tolua_isvaluenil(tolua_S, 2, &tolua_err) ||
       !tolua_isusertype(tolua_S, 2, "timer_manager", 0, &tolua_err)))
    tolua_error(tolua_S, "#vinvalid type in variable assignment.", &tolua_err);
#endif
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'get_modes_manager'",
                  NULL);
#endif
    {
      operation_manager* tolua_ret =
          (operation_manager*)self->get_modes_manager();
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'is_idle'", NULL);
#endif
    {
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'get_number'", NULL);
#endif
    {
...
static int tolua_PAC_dev_tech_object_set_err_msg00(lua_State* tolua_S) {
...
#endif
  {
    ...
    tech_object::ERR_MSG_TYPES type = ((tech_object::ERR_MSG_TYPES)(
        int)tolua_tonumber(tolua_S, 5, tech_object::ERR_CANT_ON));
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'set_err_msg'", NULL);
#endif
    {
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'is_any_message'", NULL);
#endif
    {
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'is_any_error'", NULL);
#endif
    {
...
static int tolua_PAC_dev_tech_object_manager_get_object_with_active_mode00(
    lua_State* tolua_S) {
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!tolua_isusertype(tolua_S, 1, "tech_object_manager", 0, &tolua_err) ||
      !tolua_isnumber(tolua_S, 2, 0, &tolua_err) ||
      !tolua_isnumber(tolua_S, 3, 0, &tolua_err) ||
      !tolua_isnumber(tolua_S, 4, 0, &tolua_err) ||
      !tolua_isnoobj(tolua_S, 5, &tolua_err))
...
#endif
  {
    tech_object_manager* self =
        (tech_object_manager*)tolua_tousertype(tolua_S, 1, 0);
    unsigned int mode = ((unsigned int)tolua_tonumber(tolua_S, 2, 0));
    ...
    if (!self)
      tolua_error(tolua_S,
                  "invalid 'self' in function 'get_object_with_active_mode'",
                  NULL);
#endif
    {
      int tolua_ret =
          (int)self->get_object_with_active_mode(mode, start_idx, end_idx);
      tolua_pushnumber(tolua_S, (lua_Number)tolua_ret);
    }
  }
  return 1;
#ifndef TOLUA_RELEASE
tolua_lerror:
  tolua_error(tolua_S, "#ferror in function 'get_object_with_active_mode'.",
              &tolua_err);
  return 0;
#endif
}
...
static int tolua_PAC_dev_tech_object_manager_get_tech_objects00(
    lua_State* tolua_S) {
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!tolua_isusertype(tolua_S, 1, "tech_object_manager", 0, &tolua_err) ||
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'get_tech_objects'",
                  NULL);
#endif
    {
...
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!tolua_isusertype(tolua_S, 1, "operation", 0, &tolua_err) ||
      !tolua_isnoobj(tolua_S, 2, &tolua_err))
    goto tolua_lerror;
  else
#endif
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'evaluation_time'",
                  NULL);
#endif
    {
...
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!tolua_isusertype(tolua_S, 1, "const operation", 0, &tolua_err) ||
      !tolua_isnoobj(tolua_S, 2, &tolua_err))
    goto tolua_lerror;
  else
#endif
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'active_step'", NULL);
#endif
    {
...
static int tolua_PAC_dev_operation_active_step_evaluation_time00(
    lua_State* tolua_S) {
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!tolua_isusertype(tolua_S, 1, "const operation", 0, &tolua_err) ||
...
#endif
  {
    ...
    if (!self)
      tolua_error(tolua_S,
                  "invalid 'self' in function 'active_step_evaluation_time'",
                  NULL);
#endif
    {
      unsigned long tolua_ret =
          (unsigned long)self->active_step_evaluation_time();
      tolua_pushnumber(tolua_S, (lua_Number)tolua_ret);
    }
  }
  return 1;
#ifndef TOLUA_RELEASE
tolua_lerror:
  tolua_error(tolua_S, "#ferror in function 'active_step_evaluation_time'.",
              &tolua_err);
  return 0;
#endif
}
...
static int tolua_PAC_dev_operation_get_active_step_set_time00(
    lua_State* tolua_S) {
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!tolua_isusertype(tolua_S, 1, "const operation", 0, &tolua_err) ||
...
#endif
  {
    ...
    if (!self)
      tolua_error(tolua_S,
                  "invalid 'self' in function 'get_active_step_set_time'",
                  NULL);
#endif
    {
...
#ifndef TOLUA_RELEASE
tolua_lerror:
  tolua_error(tolua_S, "#ferror in function 'get_active_step_set_time'.",
              &tolua_err);
  return 0;
#endif
}
...
static int tolua_PAC_dev_operation_to_step00(lua_State* tolua_S) {
...
#endif
  {
    ...
    unsigned long cooperative_time =
        ((unsigned long)tolua_tonumber(tolua_S, 3, 0));
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'to_step'", NULL);
#endif
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'to_next_step'", NULL);
#endif
    { self->to_next_step(); }
  }
  return 0;
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'turn_off_active_step'",
                  NULL);
#endif
...
#ifndef TOLUA_RELEASE
tolua_lerror:
  tolua_error(tolua_S, "#ferror in function 'turn_off_active_step'.",
              &tolua_err);
  return 0;
#endif
}
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'on_extra_step'", NULL);
#endif
    {
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'off_extra_step'", NULL);
#endif
    {
...
static int tolua_PAC_dev_operation_switch_active_extra_step00(
    lua_State* tolua_S) {
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!tolua_isusertype(tolua_S, 1, "operation", 0, &tolua_err) ||
...
#endif
  {
    ...
    if (!self)
      tolua_error(tolua_S,
                  "invalid 'self' in function 'switch_active_extra_step'",
                  NULL);
#endif
    {
...
#ifndef TOLUA_RELEASE
tolua_lerror:
  tolua_error(tolua_S, "#ferror in function 'switch_active_extra_step'.",
              &tolua_err);
  return 0;
#endif
}
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'is_active_extra_step'",
                  NULL);
#endif
    {
...
#ifndef TOLUA_RELEASE
tolua_lerror:
  tolua_error(tolua_S, "#ferror in function 'is_active_extra_step'.",
              &tolua_err);
  return 0;
#endif
}
...
static int tolua_PAC_dev_operation_add_step00(lua_State* tolua_S) {
...
#endif
  {
    ...
    operation::state_idx s_idx =
        ((operation::state_idx)(int)tolua_tonumber(tolua_S, 6, operation::RUN));
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'add_step'", NULL);
#endif
    {
      step* tolua_ret =
          (step*)self->add_step(name, next_step_n, step_duration_par_n,
                                step_max_duration_par_n, s_idx);
...
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!tolua_isusertype(tolua_S, 1, "operation_manager", 0, &tolua_err) ||
      !tolua_isstring(tolua_S, 2, 0, &tolua_err) ||
      !tolua_isnoobj(tolua_S, 3, &tolua_err))
    goto tolua_lerror;
  else
#endif
  {
    operation_manager* self =
        (operation_manager*)tolua_tousertype(tolua_S, 1, 0);
    const char* name = ((const char*)tolua_tostring(tolua_S, 2, 0));
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'add_mode'", NULL);
#endif
    {
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'add_operation'", NULL);
#endif
    {
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'get_idle_time'", NULL);
#endif
    {
...
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!tolua_isusertype(tolua_S, 1, "operation_state", 0, &tolua_err) ||
      !tolua_isnumber(tolua_S, 2, 0, &tolua_err) ||
      !tolua_isnoobj(tolua_S, 3, &tolua_err))
    goto tolua_lerror;
  else
...
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!tolua_isusertype(tolua_S, 1, "const operation_state", 0, &tolua_err) ||
      !tolua_isnoobj(tolua_S, 2, &tolua_err))
    goto tolua_lerror;
  else
#endif
  {
    const operation_state* self =
        (const operation_state*)tolua_tousertype(tolua_S, 1, 0);
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'steps_count'", NULL);
#endif
    {
...
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!tolua_isusertype(tolua_S, 1, "step", 0, &tolua_err) ||
      !tolua_isnumber(tolua_S, 2, 0, &tolua_err) ||
      !tolua_isnoobj(tolua_S, 3, &tolua_err))
    goto tolua_lerror;
  else
...
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!tolua_isusertype(tolua_S, 1, "const step", 0, &tolua_err) ||
      !tolua_isnoobj(tolua_S, 2, &tolua_err))
    goto tolua_lerror;
  else
#endif
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'get_name'", NULL);
#endif
    {
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'get_tag'", NULL);
#endif
    {
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'set_tag'", NULL);
#endif
...
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!tolua_isusertype(tolua_S, 1, "action", 0, &tolua_err) ||
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'add_dev'", NULL);
#endif
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'set_param_idx'", NULL);
#endif
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'set_bool_property'",
                  NULL);
#endif
    {
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'set_int_property'",
                  NULL);
#endif
    {
...
static int tolua_PAC_dev_device_manager_print00(lua_State* tolua_S) {
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!tolua_isusertype(tolua_S, 1, "const device_manager", 0, &tolua_err) ||
      !tolua_isnoobj(tolua_S, 2, &tolua_err))
    goto tolua_lerror;
  else
#endif
  {
    const device_manager* self =
        (const device_manager*)tolua_tousertype(tolua_S, 1, 0);
#ifndef TOLUA_RELEASE
    if (!self) tolua_error(tolua_S, "invalid 'self' in function 'print'", NULL);
#endif
    { self->print(); }
...
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!tolua_isusertype(tolua_S, 1, "device_manager", 0, &tolua_err) ||
      !tolua_isnumber(tolua_S, 2, 0, &tolua_err) ||
      !tolua_isnumber(tolua_S, 3, 0, &tolua_err) ||
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'add_io_device'", NULL);
#endif
    {
      io_device* tolua_ret = (io_device*)self->add_io_device(
          dev_type, dev_sub_type, dev_name, descr, article);
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'get_device'", NULL);
#endif
    {
...
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!tolua_isusertype(tolua_S, 1, "io_device", 0, &tolua_err) ||
      !tolua_isnumber(tolua_S, 2, 0, &tolua_err) ||
      !tolua_isnumber(tolua_S, 3, 0, &tolua_err) ||
      !tolua_isnumber(tolua_S, 4, 0, &tolua_err) ||
      !tolua_isnumber(tolua_S, 5, 0, &tolua_err) ||
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'init_channel'", NULL);
#endif
    {
      self->init_channel(type, ch_inex, node, offset, module_offset,
                         logical_port);
    }
  }
  return 0;
...
static int tolua_PAC_dev_io_device_set_io_vendor00(lua_State* tolua_S) {
  ...
  {
    io_device* self = (io_device*)tolua_tousertype(tolua_S, 1, 0);
    io_device::VENDOR vendor =
        ((io_device::VENDOR)(int)tolua_tonumber(tolua_S, 2, 0));
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'set_io_vendor'", NULL);
#endif
...
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!tolua_isusertype(tolua_S, 1, "timer_manager", 0, &tolua_err) ||
      !tolua_isnumber(tolua_S, 2, 0, &tolua_err) ||
      !tolua_isnoobj(tolua_S, 3, &tolua_err))
    goto tolua_lerror;
  else
...
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!tolua_isusertype(tolua_S, 1, "timer", 0, &tolua_err) ||
      !tolua_isnoobj(tolua_S, 2, &tolua_err))
    goto tolua_lerror;
  else
#endif
...
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!tolua_isusertype(tolua_S, 1, "const timer", 0, &tolua_err) ||
      !tolua_isnoobj(tolua_S, 2, &tolua_err))
    goto tolua_lerror;
  else
#endif
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'is_time_up'", NULL);
#endif
    {
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'get_work_time'", NULL);
#endif
    {
...
static int tolua_PAC_dev_timer_set_countdown_time00(lua_State* tolua_S) {
  ...
  {
    timer* self = (timer*)tolua_tousertype(tolua_S, 1, 0);
    unsigned long new_countdown_time =
        ((unsigned long)tolua_tonumber(tolua_S, 2, 0));
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'set_countdown_time'",
                  NULL);
#endif
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'get_countdown_time'",
                  NULL);
#endif
    {
...
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!tolua_isusertable(tolua_S, 1, "timer", 0, &tolua_err) ||
      !tolua_isnoobj(tolua_S, 2, &tolua_err))
    goto tolua_lerror;
  else
#endif
...
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!tolua_isusertype(tolua_S, 1, "saved_params_float", 0, &tolua_err) ||
      !tolua_isnumber(tolua_S, 2, 0, &tolua_err) ||
      !tolua_isnumber(tolua_S, 3, 0, &tolua_err) ||
      !tolua_isnoobj(tolua_S, 4, &tolua_err))
    goto tolua_lerror;
...
#endif
  {
    saved_params_float* self =
        (saved_params_float*)tolua_tousertype(tolua_S, 1, 0);
    unsigned int idx = ((unsigned int)tolua_tonumber(tolua_S, 2, 0));
    float value = ((float)tolua_tonumber(tolua_S, 3, 0));
#ifndef TOLUA_RELEASE
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'save_all'", NULL);
#endif
    {
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'reset_to_0'", NULL);
#endif
    { self->reset_to_0(); }
  }
  return 0;
...
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!tolua_isusertype(tolua_S, 1, "saved_params_u_int_4", 0, &tolua_err) ||
      !tolua_isnumber(tolua_S, 2, 0, &tolua_err) ||
      !tolua_isnumber(tolua_S, 3, 0, &tolua_err) ||
      !tolua_isnoobj(tolua_S, 4, &tolua_err))
    goto tolua_lerror;
...
#endif
  {
    saved_params_u_int_4* self =
        (saved_params_u_int_4*)tolua_tousertype(tolua_S, 1, 0);
    unsigned int idx = ((unsigned int)tolua_tonumber(tolua_S, 2, 0));
...
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!tolua_isusertype(tolua_S, 1, "run_time_params_u_int_4", 0, &tolua_err) ||
      !tolua_isnumber(tolua_S, 2, 0, &tolua_err) ||
      !tolua_isnumber(tolua_S, 3, 0, &tolua_err) ||
      !tolua_isnoobj(tolua_S, 4, &tolua_err))
    goto tolua_lerror;
...
#endif
  {
    run_time_params_u_int_4* self =
        (run_time_params_u_int_4*)tolua_tousertype(tolua_S, 1, 0);
    unsigned int idx = ((unsigned int)tolua_tonumber(tolua_S, 2, 0));
    unsigned int tolua_value = ((unsigned int)tolua_tonumber(tolua_S, 3, 0));
#ifndef TOLUA_RELEASE
    if (!self)
...
static int tolua_PAC_dev_run_time_params_u_int_4_reset_to_000(
    lua_State* tolua_S) {
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!tolua_isusertype(tolua_S, 1, "run_time_params_u_int_4", 0, &tolua_err) ||
...
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!tolua_isusertype(tolua_S, 1, "run_time_params_float", 0, &tolua_err) ||
      !tolua_isnumber(tolua_S, 2, 0, &tolua_err) ||
      !tolua_isnumber(tolua_S, 3, 0, &tolua_err) ||
      !tolua_isnoobj(tolua_S, 4, &tolua_err))
    goto tolua_lerror;
...
#endif
  {
    run_time_params_float* self =
        (run_time_params_float*)tolua_tousertype(tolua_S, 1, 0);
    unsigned int idx = ((unsigned int)tolua_tonumber(tolua_S, 2, 0));
    float tolua_value = ((float)tolua_tonumber(tolua_S, 3, 0));
#ifndef TOLUA_RELEASE
    if (!self)
...
static int tolua_PAC_dev_run_time_params_float_reset_to_000(
    lua_State* tolua_S) {
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!tolua_isusertype(tolua_S, 1, "run_time_params_float", 0, &tolua_err) ||
...
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!tolua_isusertype(tolua_S, 1, "io_manager", 0, &tolua_err) ||
      !tolua_isnumber(tolua_S, 2, 0, &tolua_err) ||
      !tolua_isnoobj(tolua_S, 3, &tolua_err))
    goto tolua_lerror;
  else
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'add_node'", NULL);
#endif
    {
      self->add_node(index, ntype, address, IP_address, name, DO_cnt, DI_cnt,
                     AO_cnt, AO_size, AI_cnt, AI_size);
    }
  }
  return 0;
#ifndef TOLUA_RELEASE
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'init_node_AO'", NULL);
#endif
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'init_node_AI'", NULL);
#endif
...
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!tolua_isusertable(tolua_S, 1, "PID", 0, &tolua_err) ||
      !tolua_isnumber(tolua_S, 2, 0, &tolua_err) ||
      !tolua_isnoobj(tolua_S, 3, &tolua_err))
    goto tolua_lerror;
  else
...
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!tolua_isusertype(tolua_S, 1, "PID", 0, &tolua_err) ||
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'get_assignment'", NULL);
#endif
    {
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'init_param'", NULL);
#endif
...
static int tolua_PAC_dev_PID_init_work_param00(lua_State* tolua_S) {
  ...
  {
    PID* self = (PID*)tolua_tousertype(tolua_S, 1, 0);
    PID::WORK_PARAM par_n =
        ((PID::WORK_PARAM)(int)tolua_tonumber(tolua_S, 2, 0));
    float val = ((float)tolua_tonumber(tolua_S, 3, 0));
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'init_work_param'",
                  NULL);
#endif
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'save_param'", NULL);
#endif
    { self->save_param(); }
  }
  return 0;
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'set_used_par'", NULL);
#endif
...
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!tolua_isusertype(tolua_S, 1, "camera", 0, &tolua_err) ||
      !tolua_isnoobj(tolua_S, 2, &tolua_err))
    goto tolua_lerror;
  else
#endif
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'get_result'", NULL);
#endif
    {
...
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!tolua_isusertype(tolua_S, 1, "const camera", 0, &tolua_err) ||
      !tolua_isnoobj(tolua_S, 2, &tolua_err))
    goto tolua_lerror;
  else
#endif
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'is_ready'", NULL);
#endif
    {
...
#ifndef TOLUA_RELEASE
  if (!self)
    tolua_error(tolua_S, "invalid 'self' in accessing variable 'par'", NULL);
#endif
...
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!tolua_isusertype(tolua_S, 1, "PAC_info", 0, &tolua_err) ||
      !tolua_isstring(tolua_S, 2, 0, &tolua_err) ||
      !tolua_isnumber(tolua_S, 3, 0, &tolua_err) ||
      !tolua_isnumber(tolua_S, 4, 0, &tolua_err) ||
      !tolua_isnoobj(tolua_S, 5, &tolua_err))
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'is_emulator'", NULL);
#endif
    {
...
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!tolua_isusertype(tolua_S, 1, "siren_lights_manager", 0, &tolua_err) ||
      !tolua_isusertype(tolua_S, 2, "device", 0, &tolua_err) ||
      !tolua_isusertype(tolua_S, 3, "device", 0, &tolua_err) ||
...
#endif
  {
    siren_lights_manager* self =
        (siren_lights_manager*)tolua_tousertype(tolua_S, 1, 0);
...
static int tolua_PAC_dev_siren_lights_manager_set_red_blink00(
    lua_State* tolua_S) {
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!tolua_isusertype(tolua_S, 1, "siren_lights_manager", 0, &tolua_err) ||
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'set_red_blink'", NULL);
#endif
...
static int tolua_PAC_dev_G_SIREN_LIGHTS_MANAGER00(lua_State* tolua_S) {
  ...
  {
    {
      siren_lights_manager* tolua_ret =
...
#ifndef TOLUA_RELEASE
tolua_lerror:
  tolua_error(tolua_S, "#ferror in function 'G_SIREN_LIGHTS_MANAGER'.",
              &tolua_err);
  return 0;
#endif
}
...
#ifndef TOLUA_RELEASE
  if (!self)
    tolua_error(tolua_S, "invalid 'self' in accessing variable 'tm_sec'", NULL);
#endif
...
#ifndef TOLUA_RELEASE
  if (!self)
    tolua_error(tolua_S, "invalid 'self' in accessing variable 'tm_min'", NULL);
#endif
...
#ifndef TOLUA_RELEASE
  if (!self)
    tolua_error(tolua_S, "invalid 'self' in accessing variable 'tm_hour'",
                NULL);
#endif
...
#ifndef TOLUA_RELEASE
  if (!self)
    tolua_error(tolua_S, "invalid 'self' in accessing variable 'tm_mday'",
                NULL);
#endif
...
#ifndef TOLUA_RELEASE
  if (!self)
    tolua_error(tolua_S, "invalid 'self' in accessing variable 'tm_mon'", NULL);
#endif
...
#ifndef TOLUA_RELEASE
  if (!self)
    tolua_error(tolua_S, "invalid 'self' in accessing variable 'tm_year'",
                NULL);
#endif
...
#ifndef TOLUA_RELEASE
  if (!self)
    tolua_error(tolua_S, "invalid 'self' in accessing variable 'tm_wday'",
                NULL);
#endif
...
#ifndef TOLUA_RELEASE
  if (!self)
    tolua_error(tolua_S, "invalid 'self' in accessing variable 'tm_yday'",
                NULL);
#endif
...
#ifndef TOLUA_RELEASE
  if (!self)
    tolua_error(tolua_S, "invalid 'self' in accessing variable 'tm_isdst'",
                NULL);
#endif
...
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!tolua_isusertype(tolua_S, 1, "MSAPID", 0, &tolua_err) ||
      !tolua_isnoobj(tolua_S, 2, &tolua_err))
    goto tolua_lerror;
  else
#endif
...
static int tolua_PAC_dev_cipline_tech_object_new00(lua_State* tolua_S) {
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!tolua_isusertable(tolua_S, 1, "cipline_tech_object", 0, &tolua_err) ||
      !tolua_isstring(tolua_S, 2, 0, &tolua_err) ||
      !tolua_isnumber(tolua_S, 3, 0, &tolua_err) ||
      !tolua_isnumber(tolua_S, 4, 0, &tolua_err) ||
      !tolua_isstring(tolua_S, 5, 0, &tolua_err) ||
...
#endif
  {
    ...
    unsigned int runtime_par_uint_count =
        ((unsigned int)tolua_tonumber(tolua_S, 11, 0));
    {
      cipline_tech_object* tolua_ret = (cipline_tech_object*)Mtolua_new(
          (cipline_tech_object)(name, number, type, name_Lua, states_count,
                                timers_count, par_float_count,
                                runtime_par_float_count, par_uint_count,
                                runtime_par_uint_count));
...
#ifndef TOLUA_RELEASE
  if (!self)
    tolua_error(tolua_S, "invalid 'self' in accessing variable 'blocked'",
                NULL);
#endif
...
#ifndef TOLUA_RELEASE
  if (!self)
    tolua_error(tolua_S, "invalid 'self' in accessing variable 'opcip'", NULL);
#endif
...
#ifndef TOLUA_RELEASE
  if (!self)
    tolua_error(tolua_S, "invalid 'self' in accessing variable 'curstep'",
                NULL);
#endif
...
#ifndef TOLUA_RELEASE
  if (!self)
    tolua_error(tolua_S, "invalid 'self' in accessing variable 'state'", NULL);
#endif
...
#ifndef TOLUA_RELEASE
  if (!self)
    tolua_error(tolua_S, "invalid 'self' in accessing variable 'curprg'", NULL);
#endif
...
#ifndef TOLUA_RELEASE
  if (!self)
    tolua_error(tolua_S, "invalid 'self' in accessing variable 'loadedRecipe'",
                NULL);
#endif
...
#ifndef TOLUA_RELEASE
  if (!self)
    tolua_error(tolua_S, "invalid 'self' in accessing variable 'loadedProgram'",
                NULL);
#endif
...
#ifndef TOLUA_RELEASE
  if (!self)
    tolua_error(tolua_S, "invalid 'self' in accessing variable 'nmr'", NULL);
#endif
...
#ifndef TOLUA_RELEASE
  if (!self)
    tolua_error(tolua_S, "invalid 'self' in accessing variable 'nplaststate'",
                NULL);
#endif
...
#ifndef TOLUA_RELEASE
  if (!self)
    tolua_error(tolua_S, "invalid 'self' in accessing variable 'pidf_override'",
                NULL);
#endif
...
#ifndef TOLUA_RELEASE
  if (!self)
    tolua_error(tolua_S, "invalid 'self' in accessing variable 'cip_in_error'",
                NULL);
#endif
...
#ifndef TOLUA_RELEASE
  if (!self)
    tolua_error(tolua_S, "invalid 'self' in accessing variable 'no_neutro'",
                NULL);
#endif
...
static int tolua_get_cipline_tech_object_dont_use_water_tank(
    lua_State* tolua_S) {
  cipline_tech_object* self =
      (cipline_tech_object*)tolua_tousertype(tolua_S, 1, 0);
#ifndef TOLUA_RELEASE
  if (!self)
    tolua_error(tolua_S,
                "invalid 'self' in accessing variable 'dont_use_water_tank'",
                NULL);
#endif
...
static int tolua_set_cipline_tech_object_dont_use_water_tank(
    lua_State* tolua_S) {
  cipline_tech_object* self =
      (cipline_tech_object*)tolua_tousertype(tolua_S, 1, 0);
#ifndef TOLUA_RELEASE
...
static int tolua_get_cipline_tech_object_disable_tank_heating(
    lua_State* tolua_S) {
  cipline_tech_object* self =
      (cipline_tech_object*)tolua_tousertype(tolua_S, 1, 0);
#ifndef TOLUA_RELEASE
  if (!self)
    tolua_error(tolua_S,
                "invalid 'self' in accessing variable 'disable_tank_heating'",
                NULL);
#endif
...
static int tolua_set_cipline_tech_object_disable_tank_heating(
    lua_State* tolua_S) {
  cipline_tech_object* self =
      (cipline_tech_object*)tolua_tousertype(tolua_S, 1, 0);
#ifndef TOLUA_RELEASE
...
#ifndef TOLUA_RELEASE
  if (!self)
    tolua_error(tolua_S, "invalid 'self' in accessing variable 'ret_overrride'",
                NULL);
#endif
...
#ifndef TOLUA_RELEASE
  if (!self)
    tolua_error(tolua_S, "invalid 'self' in accessing variable 'return_ok'",
                NULL);
#endif
...
static int tolua_get_cipline_tech_object_concentration_ok(lua_State* tolua_S) {
  ...
  if (!self)
    tolua_error(tolua_S,
                "invalid 'self' in accessing variable 'concentration_ok'",
                NULL);
#endif
...
static int tolua_get_cipline_tech_object_enable_ret_pump(lua_State* tolua_S) {
  ...
  if (!self)
    tolua_error(tolua_S,
                "invalid 'self' in accessing variable 'enable_ret_pump'", NULL);
#endif
...
static int tolua_get_cipline_tech_object_clean_water_rinsing_return(
    lua_State* tolua_S) {
  cipline_tech_object* self =
      (cipline_tech_object*)tolua_tousertype(tolua_S, 1, 0);
#ifndef TOLUA_RELEASE
  if (!self)
    tolua_error(
        tolua_S,
        "invalid 'self' in accessing variable 'clean_water_rinsing_return'",
        NULL);
#endif
...
static int tolua_set_cipline_tech_object_clean_water_rinsing_return(
    lua_State* tolua_S) {
  cipline_tech_object* self =
      (cipline_tech_object*)tolua_tousertype(tolua_S, 1, 0);
#ifndef TOLUA_RELEASE
...
#ifndef TOLUA_RELEASE
  if (!self)
    tolua_error(tolua_S, "invalid 'self' in accessing variable 'scoldvalves'",
                NULL);
#endif
...
static int tolua_get_cipline_tech_object_no_acid_wash_max(lua_State* tolua_S) {
  ...
  if (!self)
    tolua_error(tolua_S,
                "invalid 'self' in accessing variable 'no_acid_wash_max'",
                NULL);
#endif
...
static int tolua_get_cipline_tech_object_use_internal_medium_recipes(
    lua_State* tolua_S) {
  cipline_tech_object* self =
      (cipline_tech_object*)tolua_tousertype(tolua_S, 1, 0);
#ifndef TOLUA_RELEASE
  if (!self)
    tolua_error(
        tolua_S,
        "invalid 'self' in accessing variable 'use_internal_medium_recipes'",
        NULL);
#endif
...
static int tolua_set_cipline_tech_object_use_internal_medium_recipes(
    lua_State* tolua_S) {
  cipline_tech_object* self =
      (cipline_tech_object*)tolua_tousertype(tolua_S, 1, 0);
#ifndef TOLUA_RELEASE
...
static int tolua_get_cipline_tech_object_disable_final_rinsing(
    lua_State* tolua_S) {
  cipline_tech_object* self =
      (cipline_tech_object*)tolua_tousertype(tolua_S, 1, 0);
#ifndef TOLUA_RELEASE
  if (!self)
    tolua_error(tolua_S,
                "invalid 'self' in accessing variable 'disable_final_rinsing'",
                NULL);
#endif
...
static int tolua_set_cipline_tech_object_disable_final_rinsing(
    lua_State* tolua_S) {
  cipline_tech_object* self =
      (cipline_tech_object*)tolua_tousertype(tolua_S, 1, 0);
#ifndef TOLUA_RELEASE
...
static int tolua_get_cipline_tech_object_use_circulation_on_v2_supply(
    lua_State* tolua_S) {
  cipline_tech_object* self =
      (cipline_tech_object*)tolua_tousertype(tolua_S, 1, 0);
#ifndef TOLUA_RELEASE
  if (!self)
    tolua_error(
        tolua_S,
        "invalid 'self' in accessing variable 'use_circulation_on_v2_supply'",
        NULL);
#endif
...
static int tolua_set_cipline_tech_object_use_circulation_on_v2_supply(
    lua_State* tolua_S) {
  cipline_tech_object* self =
      (cipline_tech_object*)tolua_tousertype(tolua_S, 1, 0);
#ifndef TOLUA_RELEASE
...
#ifndef TOLUA_RELEASE
  if (!self)
    tolua_error(tolua_S, "invalid 'self' in accessing variable 'V00'", NULL);
#endif
...
#ifndef TOLUA_RELEASE
  if (!self)
    tolua_error(tolua_S, "invalid 'self' in accessing variable 'V01'", NULL);
#endif
...
#ifndef TOLUA_RELEASE
  if (!self)
    tolua_error(tolua_S, "invalid 'self' in accessing variable 'V02'", NULL);
#endif
...
#ifndef TOLUA_RELEASE
  if (!self)
    tolua_error(tolua_S, "invalid 'self' in accessing variable 'V03'", NULL);
#endif
...
#ifndef TOLUA_RELEASE
  if (!self)
    tolua_error(tolua_S, "invalid 'self' in accessing variable 'V04'", NULL);
#endif
...
#ifndef TOLUA_RELEASE
  if (!self)
    tolua_error(tolua_S, "invalid 'self' in accessing variable 'V05'", NULL);
#endif
...
#ifndef TOLUA_RELEASE
  if (!self)
    tolua_error(tolua_S, "invalid 'self' in accessing variable 'V06'", NULL);
#endif
...
#ifndef TOLUA_RELEASE
  if (!self)
    tolua_error(tolua_S, "invalid 'self' in accessing variable 'V07'", NULL);
#endif
...
#ifndef TOLUA_RELEASE
  if (!self)
    tolua_error(tolua_S, "invalid 'self' in accessing variable 'V08'", NULL);
#endif
...
#ifndef TOLUA_RELEASE
  if (!self)
    tolua_error(tolua_S, "invalid 'self' in accessing variable 'V09'", NULL);
#endif
...
#ifndef TOLUA_RELEASE
  if (!self)
    tolua_error(tolua_S, "invalid 'self' in accessing variable 'V10'", NULL);
#endif
...
#ifndef TOLUA_RELEASE
  if (!self)
    tolua_error(tolua_S, "invalid 'self' in accessing variable 'V11'", NULL);
#endif
...
#ifndef TOLUA_RELEASE
  if (!self)
    tolua_error(tolua_S, "invalid 'self' in accessing variable 'V12'", NULL);
#endif
...
#ifndef TOLUA_RELEASE
  if (!self)
    tolua_error(tolua_S, "invalid 'self' in accessing variable 'V13'", NULL);
#endif
...
#ifndef TOLUA_RELEASE
  if (!self)
    tolua_error(tolua_S, "invalid 'self' in accessing variable 'NP'", NULL);
#endif
...
#ifndef TOLUA_RELEASE
  if (!self)
    tolua_error(tolua_S, "invalid 'self' in accessing variable 'NK'", NULL);
#endif
...
#ifndef TOLUA_RELEASE
  if (!self)
    tolua_error(tolua_S, "invalid 'self' in accessing variable 'NS'", NULL);
#endif
...
#ifndef TOLUA_RELEASE
  if (!self)
    tolua_error(tolua_S, "invalid 'self' in accessing variable 'LL'", NULL);
#endif
...
#ifndef TOLUA_RELEASE
  if (!self)
    tolua_error(tolua_S, "invalid 'self' in accessing variable 'LM'", NULL);
#endif
...
#ifndef TOLUA_RELEASE
  if (!self)
    tolua_error(tolua_S, "invalid 'self' in accessing variable 'LH'", NULL);
#endif
...
#ifndef TOLUA_RELEASE
  if (!self)
    tolua_error(tolua_S, "invalid 'self' in accessing variable 'LWL'", NULL);
#endif
...
#ifndef TOLUA_RELEASE
  if (!self)
    tolua_error(tolua_S, "invalid 'self' in accessing variable 'LWH'", NULL);
#endif
...
#ifndef TOLUA_RELEASE
  if (!self)
    tolua_error(tolua_S, "invalid 'self' in accessing variable 'LSL'", NULL);
#endif
...
#ifndef TOLUA_RELEASE
  if (!self)
    tolua_error(tolua_S, "invalid 'self' in accessing variable 'LSH'", NULL);
#endif
...
#ifndef TOLUA_RELEASE
  if (!self)
    tolua_error(tolua_S, "invalid 'self' in accessing variable 'LKL'", NULL);
#endif
...
#ifndef TOLUA_RELEASE
  if (!self)
    tolua_error(tolua_S, "invalid 'self' in accessing variable 'LKH'", NULL);
#endif
...
#ifndef TOLUA_RELEASE
  if (!self)
    tolua_error(tolua_S, "invalid 'self' in accessing variable 'TP'", NULL);
#endif
...
#ifndef TOLUA_RELEASE
  if (!self)
    tolua_error(tolua_S, "invalid 'self' in accessing variable 'TR'", NULL);
#endif
...
#ifndef TOLUA_RELEASE
  if (!self)
    tolua_error(tolua_S, "invalid 'self' in accessing variable 'Q'", NULL);
#endif
...
#ifndef TOLUA_RELEASE
  if (!self)
    tolua_error(tolua_S, "invalid 'self' in accessing variable 'ao'", NULL);
#endif
...
#ifndef TOLUA_RELEASE
  if (!self)
    tolua_error(tolua_S, "invalid 'self' in accessing variable 'PUMPFREQ'",
                NULL);
#endif
...
#ifndef TOLUA_RELEASE
  if (!self)
    tolua_error(tolua_S, "invalid 'self' in accessing variable 'FL'", NULL);
#endif
...
#ifndef TOLUA_RELEASE
  if (!self)
    tolua_error(tolua_S, "invalid 'self' in accessing variable 'cnt'", NULL);
#endif
...
#ifndef TOLUA_RELEASE
  if (!self)
    tolua_error(tolua_S, "invalid 'self' in accessing variable 'PIDP'", NULL);
#endif
...
#ifndef TOLUA_RELEASE
  if (!self)
    tolua_error(tolua_S, "invalid 'self' in accessing variable 'PIDF'", NULL);
#endif
...
#ifndef TOLUA_RELEASE
  if (!self)
    tolua_error(tolua_S, "invalid 'self' in accessing variable 'msa_number'",
                NULL);
#endif
...
#ifndef TOLUA_RELEASE
  if (!self)
    tolua_error(tolua_S, "invalid 'self' in accessing variable 'ncar1'", NULL);
#endif
...
#ifndef TOLUA_RELEASE
  if (!self)
    tolua_error(tolua_S, "invalid 'self' in accessing variable 'ncar2'", NULL);
#endif
...
#ifndef TOLUA_RELEASE
  if (!self)
    tolua_error(tolua_S, "invalid 'self' in accessing variable 'ncar3'", NULL);
#endif
...
#ifndef TOLUA_RELEASE
  if (!self)
    tolua_error(tolua_S, "invalid 'self' in accessing variable 'ncar4'", NULL);
#endif
...
#ifndef TOLUA_RELEASE
  if (!self)
    tolua_error(tolua_S, "invalid 'self' in accessing variable 'switch1'",
                NULL);
#endif
...
#ifndef TOLUA_RELEASE
  if (!self)
    tolua_error(tolua_S, "invalid 'self' in accessing variable 'switch2'",
                NULL);
#endif
...
#ifndef TOLUA_RELEASE
  if (!self)
    tolua_error(tolua_S, "invalid 'self' in accessing variable 'switch3'",
                NULL);
#endif
...
#ifndef TOLUA_RELEASE
  if (!self)
    tolua_error(tolua_S, "invalid 'self' in accessing variable 'switch4'",
                NULL);
#endif
...
static int tolua_PAC_dev_cipline_tech_object_get_station_par00(
    lua_State* tolua_S) {
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!tolua_isusertype(tolua_S, 1, "cipline_tech_object", 0, &tolua_err) ||
      !tolua_isnumber(tolua_S, 2, 0, &tolua_err) ||
      !tolua_isnoobj(tolua_S, 3, &tolua_err))
    goto tolua_lerror;
  else
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'get_station_par'",
                  NULL);
#endif
    {
...
static int tolua_PAC_dev_cipline_tech_object_set_station_par00(
    lua_State* tolua_S) {
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!tolua_isusertype(tolua_S, 1, "cipline_tech_object", 0, &tolua_err) ||
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'set_station_par'",
                  NULL);
#endif
...
static int tolua_PAC_dev_cipline_tech_object_get_selfclean_par00(
    lua_State* tolua_S) {
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!tolua_isusertype(tolua_S, 1, "cipline_tech_object", 0, &tolua_err) ||
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'get_selfclean_par'",
                  NULL);
#endif
    {
...
static int tolua_PAC_dev_cipline_tech_object_set_selfclean_par00(
    lua_State* tolua_S) {
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!tolua_isusertype(tolua_S, 1, "cipline_tech_object", 0, &tolua_err) ||
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'set_selfclean_par'",
                  NULL);
#endif
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'initline'", NULL);
#endif
    { self->initline(); }
  }
  return 0;
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'evaluate'", NULL);
#endif
    {
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'GetConc'", NULL);
#endif
    {
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'SortRR'", NULL);
#endif
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'SetRet'", NULL);
#endif
    {
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'ForceRet'", NULL);
#endif
    {
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'GetRetState'", NULL);
#endif
    {
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'HasRet'", NULL);
#endif
    {
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'timeIsOut'", NULL);
#endif
    {
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function '_DoStep'", NULL);
#endif
    {
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function '_GoToStep'", NULL);
#endif
    {
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function '_InitStep'", NULL);
#endif
    {
...
static int tolua_PAC_dev_cipline_tech_object__LoadProgram00(
    lua_State* tolua_S) {
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!tolua_isusertype(tolua_S, 1, "cipline_tech_object", 0, &tolua_err) ||
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function '_LoadProgram'", NULL);
#endif
    {
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function '_StopDev'", NULL);
#endif
    { self->_StopDev(); }
  }
  return 0;
...
static int tolua_PAC_dev_cipline_tech_object__ResetLinesDevicesBeforeReset00(
    lua_State* tolua_S) {
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!tolua_isusertype(tolua_S, 1, "cipline_tech_object", 0, &tolua_err) ||
...
#endif
  {
    ...
    if (!self)
      tolua_error(tolua_S,
                  "invalid 'self' in function '_ResetLinesDevicesBeforeReset'",
                  NULL);
#endif
...
#ifndef TOLUA_RELEASE
tolua_lerror:
  tolua_error(tolua_S, "#ferror in function '_ResetLinesDevicesBeforeReset'.",
              &tolua_err);
  return 0;
#endif
}
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function '_OporCIP'", NULL);
#endif
    {
...
static int tolua_PAC_dev_cipline_tech_object__InitOporCIP00(
    lua_State* tolua_S) {
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!tolua_isusertype(tolua_S, 1, "cipline_tech_object", 0, &tolua_err) ||
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function '_InitOporCIP'", NULL);
#endif
    {
      int tolua_ret =
          (int)self->_InitOporCIP(where, step_to_init, not_first_call);
      tolua_pushnumber(tolua_S, (lua_Number)tolua_ret);
    }
  }
  return 1;
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function '_CheckErr'", NULL);
#endif
    {
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function '_InitCirc'", NULL);
#endif
    {
...
static int tolua_PAC_dev_cipline_tech_object__InitToObject00(
    lua_State* tolua_S) {
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!tolua_isusertype(tolua_S, 1, "cipline_tech_object", 0, &tolua_err) ||
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function '_InitToObject'", NULL);
#endif
    {
...
static int tolua_PAC_dev_cipline_tech_object__InitFromObject00(
    lua_State* tolua_S) {
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!tolua_isusertype(tolua_S, 1, "cipline_tech_object", 0, &tolua_err) ||
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function '_InitFromObject'",
                  NULL);
#endif
    {
...
static int tolua_PAC_dev_cipline_tech_object__InitFilCirc00(
    lua_State* tolua_S) {
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!tolua_isusertype(tolua_S, 1, "cipline_tech_object", 0, &tolua_err) ||
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function '_InitFilCirc'", NULL);
#endif
    {
...
static int tolua_PAC_dev_cipline_tech_object__InitOporCirc00(
    lua_State* tolua_S) {
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!tolua_isusertype(tolua_S, 1, "cipline_tech_object", 0, &tolua_err) ||
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function '_InitOporCirc'", NULL);
#endif
    {
      int tolua_ret =
          (int)self->_InitOporCirc(where, step_to_init, not_first_call);
      tolua_pushnumber(tolua_S, (lua_Number)tolua_ret);
    }
  }
  return 1;
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function '_ToObject'", NULL);
#endif
    {
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function '_FromObject'", NULL);
#endif
    {
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function '_FillCirc'", NULL);
#endif
    {
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function '_OporCirc'", NULL);
#endif
    {
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function '_InitDoseRR'", NULL);
#endif
    {
      int tolua_ret =
          (int)self->_InitDoseRR(what, step_to_init, not_first_call);
      tolua_pushnumber(tolua_S, (lua_Number)tolua_ret);
    }
  }
  return 1;
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function '_DoseRR'", NULL);
#endif
    {
...
static int tolua_PAC_dev_modbus_client_new00(lua_State* tolua_S) {
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!tolua_isusertable(tolua_S, 1, "modbus_client", 0, &tolua_err) ||
      !tolua_isnumber(tolua_S, 2, 0, &tolua_err) ||
      !tolua_isstring(tolua_S, 3, 0, &tolua_err) ||
      !tolua_isnumber(tolua_S, 4, 0, &tolua_err) ||
      !tolua_isnumber(tolua_S, 5, 0, &tolua_err) ||
...
#endif
  {
    ...
    unsigned long exchangetimeout =
        ((unsigned long)tolua_tonumber(tolua_S, 5, 0));
    {
      modbus_client* tolua_ret = (modbus_client*)Mtolua_new(
          (modbus_client)(id, ip, port, exchangetimeout));
...
static int tolua_PAC_dev_modbus_client_read_discrete_inputs00(
    lua_State* tolua_S) {
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!tolua_isusertype(tolua_S, 1, "modbus_client", 0, &tolua_err) ||
      !tolua_isnumber(tolua_S, 2, 0, &tolua_err) ||
      !tolua_isnumber(tolua_S, 3, 0, &tolua_err) ||
      !tolua_isnoobj(tolua_S, 4, &tolua_err))
    goto tolua_lerror;
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'read_discrete_inputs'",
                  NULL);
#endif
    {
...
#ifndef TOLUA_RELEASE
tolua_lerror:
  tolua_error(tolua_S, "#ferror in function 'read_discrete_inputs'.",
              &tolua_err);
  return 0;
#endif
}
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'read_coils'", NULL);
#endif
    {
...
static int tolua_PAC_dev_modbus_client_read_holding_registers00(
    lua_State* tolua_S) {
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!tolua_isusertype(tolua_S, 1, "modbus_client", 0, &tolua_err) ||
...
#endif
  {
    ...
    if (!self)
      tolua_error(tolua_S,
                  "invalid 'self' in function 'read_holding_registers'", NULL);
#endif
    {
...
#ifndef TOLUA_RELEASE
tolua_lerror:
  tolua_error(tolua_S, "#ferror in function 'read_holding_registers'.",
              &tolua_err);
  return 0;
#endif
}
...
static int tolua_PAC_dev_modbus_client_read_input_registers00(
    lua_State* tolua_S) {
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!tolua_isusertype(tolua_S, 1, "modbus_client", 0, &tolua_err) ||
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'read_input_registers'",
                  NULL);
#endif
    {
...
#ifndef TOLUA_RELEASE
tolua_lerror:
  tolua_error(tolua_S, "#ferror in function 'read_input_registers'.",
              &tolua_err);
  return 0;
#endif
}
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'write_coil'", NULL);
#endif
    {
...
static int tolua_PAC_dev_modbus_client_force_multiply_coils00(
    lua_State* tolua_S) {
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!tolua_isusertype(tolua_S, 1, "modbus_client", 0, &tolua_err) ||
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'force_multiply_coils'",
                  NULL);
#endif
    {
...
#ifndef TOLUA_RELEASE
tolua_lerror:
  tolua_error(tolua_S, "#ferror in function 'force_multiply_coils'.",
              &tolua_err);
  return 0;
#endif
}
...
static int tolua_PAC_dev_modbus_client_write_multiply_registers00(
    lua_State* tolua_S) {
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!tolua_isusertype(tolua_S, 1, "modbus_client", 0, &tolua_err) ||
...
#endif
  {
    ...
    if (!self)
      tolua_error(tolua_S,
                  "invalid 'self' in function 'write_multiply_registers'",
                  NULL);
#endif
    {
...
#ifndef TOLUA_RELEASE
tolua_lerror:
  tolua_error(tolua_S, "#ferror in function 'write_multiply_registers'.",
              &tolua_err);
  return 0;
#endif
}
...
static int tolua_PAC_dev_modbus_client_async_read_discrete_inputs00(
    lua_State* tolua_S) {
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!tolua_isusertype(tolua_S, 1, "modbus_client", 0, &tolua_err) ||
...
#endif
  {
    ...
    if (!self)
      tolua_error(tolua_S,
                  "invalid 'self' in function 'async_read_discrete_inputs'",
                  NULL);
#endif
    {
      int tolua_ret =
          (int)self->async_read_discrete_inputs(start_address, quantity);
      tolua_pushnumber(tolua_S, (lua_Number)tolua_ret);
    }
  }
  return 1;
#ifndef TOLUA_RELEASE
tolua_lerror:
  tolua_error(tolua_S, "#ferror in function 'async_read_discrete_inputs'.",
              &tolua_err);
  return 0;
#endif
}
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'async_read_coils'",
                  NULL);
#endif
    {
...
static int tolua_PAC_dev_modbus_client_async_read_holding_registers00(
    lua_State* tolua_S) {
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!tolua_isusertype(tolua_S, 1, "modbus_client", 0, &tolua_err) ||
...
#endif
  {
    ...
    if (!self)
      tolua_error(tolua_S,
                  "invalid 'self' in function 'async_read_holding_registers'",
                  NULL);
#endif
    {
      int tolua_ret =
          (int)self->async_read_holding_registers(address, quantity);
      tolua_pushnumber(tolua_S, (lua_Number)tolua_ret);
    }
  }
  return 1;
#ifndef TOLUA_RELEASE
tolua_lerror:
  tolua_error(tolua_S, "#ferror in function 'async_read_holding_registers'.",
              &tolua_err);
  return 0;
#endif
}
...
static int tolua_PAC_dev_modbus_client_async_read_input_registers00(
    lua_State* tolua_S) {
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!tolua_isusertype(tolua_S, 1, "modbus_client", 0, &tolua_err) ||
...
#endif
  {
    ...
    if (!self)
      tolua_error(tolua_S,
                  "invalid 'self' in function 'async_read_input_registers'",
                  NULL);
#endif
    {
...
#ifndef TOLUA_RELEASE
tolua_lerror:
  tolua_error(tolua_S, "#ferror in function 'async_read_input_registers'.",
              &tolua_err);
  return 0;
#endif
}
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'async_write_coil'",
                  NULL);
#endif
    {
...
static int tolua_PAC_dev_modbus_client_async_force_multiply_coils00(
    lua_State* tolua_S) {
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!tolua_isusertype(tolua_S, 1, "modbus_client", 0, &tolua_err) ||
...
#endif
  {
    ...
    if (!self)
      tolua_error(tolua_S,
                  "invalid 'self' in function 'async_force_multiply_coils'",
                  NULL);
#endif
    {
...
#ifndef TOLUA_RELEASE
tolua_lerror:
  tolua_error(tolua_S, "#ferror in function 'async_force_multiply_coils'.",
              &tolua_err);
  return 0;
#endif
}
...
static int tolua_PAC_dev_modbus_client_async_write_multiply_registers00(
    lua_State* tolua_S) {
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!tolua_isusertype(tolua_S, 1, "modbus_client", 0, &tolua_err) ||
...
#endif
  {
    ...
    if (!self)
      tolua_error(tolua_S,
                  "invalid 'self' in function 'async_write_multiply_registers'",
                  NULL);
#endif
    {
      int tolua_ret =
          (int)self->async_write_multiply_registers(address, quantity);
      tolua_pushnumber(tolua_S, (lua_Number)tolua_ret);
    }
  }
  return 1;
#ifndef TOLUA_RELEASE
tolua_lerror:
  tolua_error(tolua_S, "#ferror in function 'async_write_multiply_registers'.",
              &tolua_err);
  return 0;
#endif
}
...
static int tolua_PAC_dev_modbus_client_async_read_write_multiply_registers00(
    lua_State* tolua_S) {
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!tolua_isusertype(tolua_S, 1, "modbus_client", 0, &tolua_err) ||
...
#endif
  {
    ...
    if (!self)
      tolua_error(
          tolua_S,
          "invalid 'self' in function 'async_read_write_multiply_registers'",
          NULL);
#endif
    {
      int tolua_ret = (int)self->async_read_write_multiply_registers(
          readaddress, readquantity, wrireaddress, writequantity);
      tolua_pushnumber(tolua_S, (lua_Number)tolua_ret);
    }
  }
  return 1;
...
tolua_lerror:
  tolua_error(tolua_S,
              "#ferror in function 'async_read_write_multiply_registers'.",
              &tolua_err);
  return 0;
#endif
}
...
static int tolua_PAC_dev_modbus_client_async_mask_write_register00(
    lua_State* tolua_S) {
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!tolua_isusertype(tolua_S, 1, "modbus_client", 0, &tolua_err) ||
...
#endif
  {
    ...
    if (!self)
      tolua_error(tolua_S,
                  "invalid 'self' in function 'async_mask_write_register'",
                  NULL);
#endif
    {
      int tolua_ret =
          (int)self->async_mask_write_register(writeaddress, andmask, ormask);
      tolua_pushnumber(tolua_S, (lua_Number)tolua_ret);
    }
  }
  return 1;
#ifndef TOLUA_RELEASE
tolua_lerror:
  tolua_error(tolua_S, "#ferror in function 'async_mask_write_register'.",
              &tolua_err);
  return 0;
#endif
}
...
static int tolua_PAC_dev_modbus_client_async_mask_write_register01(
    lua_State* tolua_S) {
  tolua_Error tolua_err;
  if (!tolua_isusertype(tolua_S, 1, "modbus_client", 0, &tolua_err) ||
      !tolua_isnumber(tolua_S, 2, 0, &tolua_err) ||
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'get_async_result'",
                  NULL);
#endif
    {
...
static int tolua_PAC_dev_modbus_client_set_station00(lua_State* tolua_S) {
  ...
  {
    modbus_client* self = (modbus_client*)tolua_tousertype(tolua_S, 1, 0);
    unsigned char new_station_id =
        ((unsigned char)tolua_tonumber(tolua_S, 2, 0));
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'set_station'", NULL);
#endif
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'zero_output_buff'",
                  NULL);
#endif
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'set_byte'", NULL);
#endif
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'get_byte'", NULL);
#endif
    {
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'set_int2'", NULL);
#endif
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'get_int2'", NULL);
#endif
    {
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'set_int4'", NULL);
#endif
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'get_int4'", NULL);
#endif
    {
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'set_float'", NULL);
#endif
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'get_float'", NULL);
#endif
    {
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'set_bit'", NULL);
#endif
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'get_bit'", NULL);
#endif
    {
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'reg_get_bit'", NULL);
#endif
    {
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'reg_set_bit'", NULL);
#endif
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'mask_reset'", NULL);
#endif
    { self->mask_reset(); }
  }
  return 0;
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'mask_set_bit'", NULL);
#endif
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'swapBits'", NULL);
#endif
    {
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'get_id'", NULL);
#endif
    {
...
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!tolua_isusertable(tolua_S, 1, "ModbusServ", 0, &tolua_err) ||
      !tolua_isstring(tolua_S, 2, 0, &tolua_err) ||
      !tolua_isnumber(tolua_S, 3, 0, &tolua_err) ||
      !tolua_isnoobj(tolua_S, 4, &tolua_err))
    goto tolua_lerror;
...
#endif
  {
    ...
    int offset = ((int)tolua_tonumber(tolua_S, 3, 0));
    {
      unsigned int tolua_ret =
          (unsigned int)ModbusServ::UnpackWord(Buf, offset);
      tolua_pushnumber(tolua_S, (lua_Number)tolua_ret);
    }
  }
  return 1;
...
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!tolua_isusertype(tolua_S, 1, "profibus_slave", 0, &tolua_err) ||
      !tolua_isnoobj(tolua_S, 2, &tolua_err))
    goto tolua_lerror;
  else
#endif
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'activate'", NULL);
#endif
    { self->activate(); }
  }
  return 0;
...
static int tolua_PAC_dev_profibus_slave_set_station_address00(
    lua_State* tolua_S) {
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!tolua_isusertype(tolua_S, 1, "profibus_slave", 0, &tolua_err) ||
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'set_station_address'",
                  NULL);
#endif
...
#ifndef TOLUA_RELEASE
tolua_lerror:
  tolua_error(tolua_S, "#ferror in function 'set_station_address'.",
              &tolua_err);
  return 0;
#endif
}
...
static int tolua_PAC_dev_profibus_slave_set_output_byte_size00(
    lua_State* tolua_S) {
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!tolua_isusertype(tolua_S, 1, "profibus_slave", 0, &tolua_err) ||
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'set_output_byte_size'",
                  NULL);
#endif
...
#ifndef TOLUA_RELEASE
tolua_lerror:
  tolua_error(tolua_S, "#ferror in function 'set_output_byte_size'.",
              &tolua_err);
  return 0;
#endif
}
...
static int tolua_PAC_dev_profibus_slave_set_input_byte_size00(
    lua_State* tolua_S) {
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!tolua_isusertype(tolua_S, 1, "profibus_slave", 0, &tolua_err) ||
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'set_input_byte_size'",
                  NULL);
#endif
...
#ifndef TOLUA_RELEASE
tolua_lerror:
  tolua_error(tolua_S, "#ferror in function 'set_input_byte_size'.",
              &tolua_err);
  return 0;
#endif
}
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'get_double'", NULL);
#endif
    {
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'get_bool'", NULL);
#endif
    {
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'set_bool'", NULL);
#endif
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'get_int'", NULL);
#endif
    {
...
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'set_int'", NULL);
#endif
...
#ifndef TOLUA_RELEASE
tolua_lerror:
  tolua_error(tolua_S, "#ferror in function 'G_PROFIBUS_SLAVE_LUA'.",
              &tolua_err);
  return 0;
#endif
}
...
static int tolua_PAC_dev_i_log_write_log00(lua_State* tolua_S) {
#ifndef TOLUA_RELEASE
  tolua_Error tolua_err;
  if (!tolua_isusertype(tolua_S, 1, "i_log", 0, &tolua_err) ||
      !tolua_isnumber(tolua_S, 2, 0, &tolua_err) ||
      !tolua_isstring(tolua_S, 3, 0, &tolua_err) ||
      !tolua_isnoobj(tolua_S, 4, &tolua_err))
    goto tolua_lerror;
...
#endif
  {
    ...
    i_log::PRIORITIES priority =
        ((i_log::PRIORITIES)(int)tolua_tonumber(tolua_S, 2, 0));
    const char* debug_message = ((const char*)tolua_tostring(tolua_S, 3, 0));
#ifndef TOLUA_RELEASE
    if (!self)
      tolua_error(tolua_S, "invalid 'self' in function 'write_log'", NULL);
#endif
...
TOLUA_API int tolua_PAC_dev_open(lua_State* tolua_S) {
  ...
  tolua_function(tolua_S, "instant_off",
                 tolua_PAC_dev_i_DO_device_instant_off00);
  ...
  tolua_endmodule(tolua_S);
  tolua_cclass(tolua_S, "i_DO_AO_device", "i_DO_AO_device", "i_DO_device",
               NULL);
  tolua_beginmodule(tolua_S, "i_DO_AO_device");
  tolua_function(tolua_S, "get_state",
                 tolua_PAC_dev_i_DO_AO_device_get_state00);
  tolua_function(tolua_S, "set_state",
                 tolua_PAC_dev_i_DO_AO_device_set_state00);
  tolua_function(tolua_S, "on", tolua_PAC_dev_i_DO_AO_device_on00);
  tolua_function(tolua_S, "off", tolua_PAC_dev_i_DO_AO_device_off00);
  tolua_function(tolua_S, "get_value",
                 tolua_PAC_dev_i_DO_AO_device_get_value00);
  tolua_function(tolua_S, "set_value",
                 tolua_PAC_dev_i_DO_AO_device_set_value00);
  tolua_variable(tolua_S, "__i_AO_device__",
                 tolua_get_i_DO_AO_device___i_AO_device__, NULL);
  tolua_endmodule(tolua_S);
  ...
  tolua_function(tolua_S, "get_quantity",
                 tolua_PAC_dev_i_counter_get_quantity00);
  ...
  tolua_function(tolua_S, "get_abs_quantity",
                 tolua_PAC_dev_i_counter_get_abs_quantity00);
  ...
  tolua_function(tolua_S, "set_string_property",
                 tolua_PAC_dev_device_set_string_property00);
  ...
  tolua_function(tolua_S, "param_emulator",
                 tolua_PAC_dev_device_param_emulator00);
  ...
  tolua_constant(tolua_S, "DST_V_BOTTOM_MIXPROOF",
                 device::DST_V_BOTTOM_MIXPROOF);
  ...
  tolua_constant(tolua_S, "V_IOLINK_VTUG_DO1_FB_OFF",
                 device::V_IOLINK_VTUG_DO1_FB_OFF);
  tolua_constant(tolua_S, "V_IOLINK_VTUG_DO1_FB_ON",
                 device::V_IOLINK_VTUG_DO1_FB_ON);
  ...
  tolua_constant(tolua_S, "V_IOLINK_VTUG_DO1_DI2",
                 device::V_IOLINK_VTUG_DO1_DI2);
  tolua_constant(tolua_S, "DST_V_VIRT", device::DST_V_VIRT);
  tolua_constant(tolua_S, "DST_V_MINI_FLUSHING", device::DST_V_MINI_FLUSHING);
  tolua_constant(tolua_S, "V_IOL_TERMINAL_MIXPROOF_DO3",
                 device::V_IOL_TERMINAL_MIXPROOF_DO3);
  tolua_constant(tolua_S, "V_IOL_TERMINAL_MIXPROOF_DO3_DI2",
                 device::V_IOL_TERMINAL_MIXPROOF_DO3_DI2);
  ...
  tolua_constant(tolua_S, "DST_M_REV_FREQ_2_ERROR",
                 device::DST_M_REV_FREQ_2_ERROR);
  ...
  tolua_function(tolua_S, "get_linear_speed",
                 tolua_PAC_dev_i_motor_get_linear_speed00);
  ...
  tolua_function(tolua_S, "turn_off_red",
                 tolua_PAC_dev_signal_column_turn_off_red00);
  tolua_function(tolua_S, "turn_off_yellow",
                 tolua_PAC_dev_signal_column_turn_off_yellow00);
  tolua_function(tolua_S, "turn_off_green",
                 tolua_PAC_dev_signal_column_turn_off_green00);
  tolua_function(tolua_S, "turn_off_blue",
                 tolua_PAC_dev_signal_column_turn_off_blue00);
  tolua_function(tolua_S, "turn_on_red",
                 tolua_PAC_dev_signal_column_turn_on_red00);
  tolua_function(tolua_S, "turn_on_yellow",
                 tolua_PAC_dev_signal_column_turn_on_yellow00);
  tolua_function(tolua_S, "turn_on_green",
                 tolua_PAC_dev_signal_column_turn_on_green00);
  tolua_function(tolua_S, "turn_on_blue",
                 tolua_PAC_dev_signal_column_turn_on_blue00);
  tolua_function(tolua_S, "normal_blink_red",
                 tolua_PAC_dev_signal_column_normal_blink_red00);
  tolua_function(tolua_S, "normal_blink_yellow",
                 tolua_PAC_dev_signal_column_normal_blink_yellow00);
  tolua_function(tolua_S, "normal_blink_green",
                 tolua_PAC_dev_signal_column_normal_blink_green00);
  tolua_function(tolua_S, "normal_blink_blue",
                 tolua_PAC_dev_signal_column_normal_blink_blue00);
  tolua_function(tolua_S, "slow_blink_red",
                 tolua_PAC_dev_signal_column_slow_blink_red00);
  tolua_function(tolua_S, "slow_blink_yellow",
                 tolua_PAC_dev_signal_column_slow_blink_yellow00);
  tolua_function(tolua_S, "slow_blink_green",
                 tolua_PAC_dev_signal_column_slow_blink_green00);
  tolua_function(tolua_S, "slow_blink_blue",
                 tolua_PAC_dev_signal_column_slow_blink_blue00);
  tolua_function(tolua_S, "turn_on_siren",
                 tolua_PAC_dev_signal_column_turn_on_siren00);
  tolua_function(tolua_S, "turn_off_siren",
                 tolua_PAC_dev_signal_column_turn_off_siren00);
  ...
  tolua_constant(tolua_S, "GREEN_NORMAL_BLINK",
                 signal_column::GREEN_NORMAL_BLINK);
  tolua_constant(tolua_S, "YELLOW_NORMAL_BLINK",
                 signal_column::YELLOW_NORMAL_BLINK);
  ...
  tolua_constant(tolua_S, "YELLOW_SLOW_BLINK",
                 signal_column::YELLOW_SLOW_BLINK);
  ...
  tolua_function(tolua_S, "show_error_exists",
                 tolua_PAC_dev_signal_column_show_error_exists00);
  tolua_function(tolua_S, "show_message_exists",
                 tolua_PAC_dev_signal_column_show_message_exists00);
  tolua_function(tolua_S, "show_batch_is_not_running",
                 tolua_PAC_dev_signal_column_show_batch_is_not_running00);
  tolua_function(tolua_S, "show_batch_is_running",
                 tolua_PAC_dev_signal_column_show_batch_is_running00);
  tolua_function(tolua_S, "show_operation_is_not_running",
                 tolua_PAC_dev_signal_column_show_operation_is_not_running00);
  tolua_function(tolua_S, "show_operation_is_running",
                 tolua_PAC_dev_signal_column_show_operation_is_running00);
  ...
  tolua_function(tolua_S, "get_quantity",
                 tolua_PAC_dev_dev_stub_get_quantity00);
  tolua_endmodule(tolua_S);
  tolua_cclass(tolua_S, "errors_manager", "errors_manager", "", NULL);
  tolua_beginmodule(tolua_S, "errors_manager");
  tolua_function(tolua_S, "get_instance",
                 tolua_PAC_dev_errors_manager_get_instance00);
  ...
  tolua_function(tolua_S, "get_instance",
                 tolua_PAC_dev_dev_errors_manager_get_instance00);
  tolua_function(tolua_S, "set_cmd",
                 tolua_PAC_dev_dev_errors_manager_set_cmd00);
  tolua_endmodule(tolua_S);
  ...
  tolua_function(tolua_S, "get_on_fb_value",
                 tolua_PAC_dev_valve_get_on_fb_value00);
  tolua_function(tolua_S, "get_off_fb_value",
                 tolua_PAC_dev_valve_get_off_fb_value00);
  ...
  tolua_function(tolua_S, "get_quantity",
                 tolua_PAC_dev_virtual_counter_get_quantity00);
  tolua_function(tolua_S, "get_flow", tolua_PAC_dev_virtual_counter_get_flow00);
  tolua_function(tolua_S, "get_state",
                 tolua_PAC_dev_virtual_counter_get_state00);
  tolua_function(tolua_S, "get_abs_quantity",
                 tolua_PAC_dev_virtual_counter_get_abs_quantity00);
  tolua_function(tolua_S, "abs_reset",
                 tolua_PAC_dev_virtual_counter_abs_reset00);
  ...
  tolua_endmodule(tolua_S);
#ifdef __cplusplus
  tolua_cclass(tolua_S, "tech_object", "tech_object", "",
               tolua_collect_tech_object);
#else
  ...
  tolua_function(tolua_S, "get_operation_state",
                 tolua_PAC_dev_tech_object_get_operation_state00);
  tolua_function(tolua_S, "exec_cmd", tolua_PAC_dev_tech_object_exec_cmd00);
  tolua_function(tolua_S, "get_modes_count",
                 tolua_PAC_dev_tech_object_get_modes_count00);
  tolua_function(tolua_S, "check_operation_on",
                 tolua_PAC_dev_tech_object_check_operation_on00);
  tolua_variable(tolua_S, "par_float", tolua_get_tech_object_par_float,
                 tolua_set_tech_object_par_float);
  tolua_variable(tolua_S, "rt_par_float", tolua_get_tech_object_rt_par_float,
                 tolua_set_tech_object_rt_par_float);
  tolua_variable(tolua_S, "par_uint", tolua_get_tech_object_par_uint,
                 tolua_set_tech_object_par_uint);
  tolua_variable(tolua_S, "rt_par_uint", tolua_get_tech_object_rt_par_uint,
                 tolua_set_tech_object_rt_par_uint);
  tolua_variable(tolua_S, "timers", tolua_get_tech_object_timers,
                 tolua_set_tech_object_timers);
  tolua_function(tolua_S, "get_modes_manager",
                 tolua_PAC_dev_tech_object_get_modes_manager00);
  ...
  tolua_constant(tolua_S, "ERR_ON_WITH_ERRORS",
                 tech_object::ERR_ON_WITH_ERRORS);
  ...
  tolua_constant(tolua_S, "ERR_CANT_ON_2_OPER",
                 tech_object::ERR_CANT_ON_2_OPER);
  tolua_constant(tolua_S, "ERR_CANT_ON_2_OBJ", tech_object::ERR_CANT_ON_2_OBJ);
  tolua_function(tolua_S, "set_err_msg",
                 tolua_PAC_dev_tech_object_set_err_msg00);
  tolua_function(tolua_S, "is_any_message",
                 tolua_PAC_dev_tech_object_is_any_message00);
  tolua_function(tolua_S, "is_any_error",
                 tolua_PAC_dev_tech_object_is_any_error00);
  tolua_endmodule(tolua_S);
  tolua_function(tolua_S, "G_TECH_OBJECT_MNGR",
                 tolua_PAC_dev_G_TECH_OBJECT_MNGR00);
  tolua_cclass(tolua_S, "tech_object_manager", "tech_object_manager", "", NULL);
  tolua_beginmodule(tolua_S, "tech_object_manager");
  tolua_function(
      tolua_S, "get_object_with_active_mode",
      tolua_PAC_dev_tech_object_manager_get_object_with_active_mode00);
  tolua_function(tolua_S, "get_tech_objects",
                 tolua_PAC_dev_tech_object_manager_get_tech_objects00);
  ...
  tolua_function(tolua_S, "evaluation_time",
                 tolua_PAC_dev_operation_evaluation_time00);
  tolua_function(tolua_S, "active_step", tolua_PAC_dev_operation_active_step00);
  tolua_function(tolua_S, "active_step_evaluation_time",
                 tolua_PAC_dev_operation_active_step_evaluation_time00);
  tolua_function(tolua_S, "get_active_step_set_time",
                 tolua_PAC_dev_operation_get_active_step_set_time00);
  tolua_function(tolua_S, "to_step", tolua_PAC_dev_operation_to_step00);
  tolua_function(tolua_S, "to_next_step",
                 tolua_PAC_dev_operation_to_next_step00);
  tolua_function(tolua_S, "turn_off_active_step",
                 tolua_PAC_dev_operation_turn_off_active_step00);
  tolua_function(tolua_S, ".geti", tolua_PAC_dev_operation__geti00);
  tolua_function(tolua_S, "on_extra_step",
                 tolua_PAC_dev_operation_on_extra_step00);
  tolua_function(tolua_S, "off_extra_step",
                 tolua_PAC_dev_operation_off_extra_step00);
  tolua_function(tolua_S, "switch_active_extra_step",
                 tolua_PAC_dev_operation_switch_active_extra_step00);
  tolua_function(tolua_S, "is_active_extra_step",
                 tolua_PAC_dev_operation_is_active_extra_step00);
  ...
  tolua_function(tolua_S, "add_mode",
                 tolua_PAC_dev_operation_manager_add_mode00);
  tolua_function(tolua_S, "add_operation",
                 tolua_PAC_dev_operation_manager_add_operation00);
  tolua_function(tolua_S, ".geti", tolua_PAC_dev_operation_manager__geti00);
  tolua_function(tolua_S, "get_idle_time",
                 tolua_PAC_dev_operation_manager_get_idle_time00);
  tolua_endmodule(tolua_S);
  ...
  tolua_function(tolua_S, "steps_count",
                 tolua_PAC_dev_operation_state_steps_count00);
  tolua_endmodule(tolua_S);
  ...
  tolua_constant(tolua_S, "A_ENABLE_STEP_BY_SIGNAL",
                 step::A_ENABLE_STEP_BY_SIGNAL);
  ...
  tolua_function(tolua_S, "set_param_idx",
                 tolua_PAC_dev_action_set_param_idx00);
  tolua_function(tolua_S, "set_bool_property",
                 tolua_PAC_dev_action_set_bool_property00);
  tolua_function(tolua_S, "set_int_property",
                 tolua_PAC_dev_action_set_int_property00);
  tolua_endmodule(tolua_S);
  ...
  tolua_function(tolua_S, "add_io_device",
                 tolua_PAC_dev_device_manager_add_io_device00);
  tolua_function(tolua_S, "get_device",
                 tolua_PAC_dev_device_manager_get_device00);
  tolua_endmodule(tolua_S);
  ...
  tolua_function(tolua_S, "init_channel",
                 tolua_PAC_dev_io_device_init_channel00);
  tolua_function(tolua_S, "set_io_vendor",
                 tolua_PAC_dev_io_device_set_io_vendor00);
  tolua_endmodule(tolua_S);
  ...
  tolua_function(tolua_S, "set_countdown_time",
                 tolua_PAC_dev_timer_set_countdown_time00);
  tolua_function(tolua_S, "get_countdown_time",
                 tolua_PAC_dev_timer_get_countdown_time00);
  ...
  tolua_function(tolua_S, "save_all",
                 tolua_PAC_dev_saved_params_float_save_all00);
  ...
  tolua_function(tolua_S, "reset_to_0",
                 tolua_PAC_dev_saved_params_float_reset_to_000);
  tolua_endmodule(tolua_S);
  tolua_cclass(tolua_S, "saved_params_u_int_4", "saved_params_u_int_4", "",
               NULL);
  tolua_beginmodule(tolua_S, "saved_params_u_int_4");
  tolua_function(tolua_S, "save", tolua_PAC_dev_saved_params_u_int_4_save00);
  tolua_function(tolua_S, "save_all",
                 tolua_PAC_dev_saved_params_u_int_4_save_all00);
  ...
  tolua_function(tolua_S, "reset_to_0",
                 tolua_PAC_dev_saved_params_u_int_4_reset_to_000);
  tolua_endmodule(tolua_S);
  tolua_cclass(tolua_S, "run_time_params_u_int_4", "run_time_params_u_int_4",
               "", NULL);
  tolua_beginmodule(tolua_S, "run_time_params_u_int_4");
  tolua_function(tolua_S, ".seti",
                 tolua_PAC_dev_run_time_params_u_int_4__seti00);
  tolua_function(tolua_S, ".geti",
                 tolua_PAC_dev_run_time_params_u_int_4__geti00);
  tolua_function(tolua_S, "reset_to_0",
                 tolua_PAC_dev_run_time_params_u_int_4_reset_to_000);
  tolua_endmodule(tolua_S);
  tolua_cclass(tolua_S, "run_time_params_float", "run_time_params_float", "",
               NULL);
  ...
  tolua_function(tolua_S, "reset_to_0",
                 tolua_PAC_dev_run_time_params_float_reset_to_000);
  tolua_endmodule(tolua_S);
  ...
  tolua_function(tolua_S, "init_node_AO",
                 tolua_PAC_dev_io_manager_init_node_AO00);
  tolua_function(tolua_S, "init_node_AI",
                 tolua_PAC_dev_io_manager_init_node_AI00);
  tolua_endmodule(tolua_S);
  ...
  tolua_function(tolua_S, "init_work_param",
                 tolua_PAC_dev_PID_init_work_param00);
  ...
  tolua_constant(tolua_S, "P_MIX_FLIP_UPPER_TIME",
                 PAC_info::P_MIX_FLIP_UPPER_TIME);
  tolua_constant(tolua_S, "P_MIX_FLIP_LOWER_TIME",
                 PAC_info::P_MIX_FLIP_LOWER_TIME);
  tolua_constant(tolua_S, "P_V_OFF_DELAY_TIME", PAC_info::P_V_OFF_DELAY_TIME);
  tolua_constant(tolua_S, "P_V_BOTTOM_OFF_DELAY_TIME",
                 PAC_info::P_V_BOTTOM_OFF_DELAY_TIME);
  tolua_constant(tolua_S, "P_WAGO_TCP_NODE_WARN_ANSWER_AVG_TIME",
                 PAC_info::P_WAGO_TCP_NODE_WARN_ANSWER_AVG_TIME);
  tolua_constant(tolua_S, "P_MAIN_CYCLE_WARN_ANSWER_AVG_TIME",
                 PAC_info::P_MAIN_CYCLE_WARN_ANSWER_AVG_TIME);
  tolua_constant(tolua_S, "P_RESTRICTIONS_MODE", PAC_info::P_RESTRICTIONS_MODE);
  tolua_constant(tolua_S, "P_RESTRICTIONS_MANUAL_TIME",
                 PAC_info::P_RESTRICTIONS_MANUAL_TIME);
  tolua_constant(tolua_S, "P_AUTO_PAUSE_OPER_ON_DEV_ERR",
                 PAC_info::P_AUTO_PAUSE_OPER_ON_DEV_ERR);
  tolua_variable(tolua_S, "par", tolua_get_PAC_info_par,
                 tolua_set_PAC_info_par);
  ...
  tolua_endmodule(tolua_S);
  tolua_cclass(tolua_S, "siren_lights_manager", "siren_lights_manager", "",
               NULL);
  tolua_beginmodule(tolua_S, "siren_lights_manager");
  tolua_function(tolua_S, "init", tolua_PAC_dev_siren_lights_manager_init00);
  tolua_function(tolua_S, "set_red_blink",
                 tolua_PAC_dev_siren_lights_manager_set_red_blink00);
  tolua_endmodule(tolua_S);
  tolua_function(tolua_S, "G_SIREN_LIGHTS_MANAGER",
                 tolua_PAC_dev_G_SIREN_LIGHTS_MANAGER00);
  ...
  tolua_function(tolua_S, "get_delta_millisec",
                 tolua_PAC_dev_get_delta_millisec00);
  ...
  tolua_variable(tolua_S, "tm_hour", tolua_get_tm_tm_hour,
                 tolua_set_tm_tm_hour);
  tolua_variable(tolua_S, "tm_mday", tolua_get_tm_tm_mday,
                 tolua_set_tm_tm_mday);
  tolua_variable(tolua_S, "tm_mon", tolua_get_tm_tm_mon, tolua_set_tm_tm_mon);
  tolua_variable(tolua_S, "tm_year", tolua_get_tm_tm_year,
                 tolua_set_tm_tm_year);
  tolua_variable(tolua_S, "tm_wday", tolua_get_tm_tm_wday,
                 tolua_set_tm_tm_wday);
  tolua_variable(tolua_S, "tm_yday", tolua_get_tm_tm_yday,
                 tolua_set_tm_tm_yday);
  tolua_variable(tolua_S, "tm_isdst", tolua_get_tm_tm_isdst,
                 tolua_set_tm_tm_isdst);
  tolua_endmodule(tolua_S);
  ...
  tolua_endmodule(tolua_S);
#ifdef __cplusplus
  tolua_cclass(tolua_S, "cipline_tech_object", "cipline_tech_object",
               "tech_object", tolua_collect_cipline_tech_object);
#else
  tolua_cclass(tolua_S, "cipline_tech_object", "cipline_tech_object",
               "tech_object", NULL);
#endif
  ...
  tolua_function(tolua_S, "new_local",
                 tolua_PAC_dev_cipline_tech_object_new00_local);
  tolua_function(tolua_S, ".call",
                 tolua_PAC_dev_cipline_tech_object_new00_local);
  tolua_variable(tolua_S, "blocked", tolua_get_cipline_tech_object_blocked,
                 tolua_set_cipline_tech_object_blocked);
  tolua_variable(tolua_S, "opcip", tolua_get_cipline_tech_object_opcip,
                 tolua_set_cipline_tech_object_opcip);
  tolua_variable(tolua_S, "curstep", tolua_get_cipline_tech_object_curstep,
                 tolua_set_cipline_tech_object_curstep);
  tolua_variable(tolua_S, "state", tolua_get_cipline_tech_object_state,
                 tolua_set_cipline_tech_object_state);
  tolua_variable(tolua_S, "curprg", tolua_get_cipline_tech_object_curprg,
                 tolua_set_cipline_tech_object_curprg);
  tolua_variable(tolua_S, "loadedRecipe",
                 tolua_get_cipline_tech_object_loadedRecipe,
                 tolua_set_cipline_tech_object_loadedRecipe);
  tolua_variable(tolua_S, "loadedProgram",
                 tolua_get_cipline_tech_object_loadedProgram,
                 tolua_set_cipline_tech_object_loadedProgram);
  tolua_variable(tolua_S, "nmr", tolua_get_cipline_tech_object_nmr,
                 tolua_set_cipline_tech_object_nmr);
  tolua_variable(tolua_S, "nplaststate",
                 tolua_get_cipline_tech_object_nplaststate,
                 tolua_set_cipline_tech_object_nplaststate);
  tolua_variable(tolua_S, "pidf_override",
                 tolua_get_cipline_tech_object_pidf_override,
                 tolua_set_cipline_tech_object_pidf_override);
  tolua_variable(tolua_S, "cip_in_error",
                 tolua_get_cipline_tech_object_cip_in_error,
                 tolua_set_cipline_tech_object_cip_in_error);
  tolua_variable(tolua_S, "no_neutro", tolua_get_cipline_tech_object_no_neutro,
                 tolua_set_cipline_tech_object_no_neutro);
  tolua_variable(tolua_S, "dont_use_water_tank",
                 tolua_get_cipline_tech_object_dont_use_water_tank,
                 tolua_set_cipline_tech_object_dont_use_water_tank);
  tolua_variable(tolua_S, "disable_tank_heating",
                 tolua_get_cipline_tech_object_disable_tank_heating,
                 tolua_set_cipline_tech_object_disable_tank_heating);
  tolua_variable(tolua_S, "ret_overrride",
                 tolua_get_cipline_tech_object_ret_overrride,
                 tolua_set_cipline_tech_object_ret_overrride);
  tolua_variable(tolua_S, "return_ok", tolua_get_cipline_tech_object_return_ok,
                 tolua_set_cipline_tech_object_return_ok);
  tolua_variable(tolua_S, "concentration_ok",
                 tolua_get_cipline_tech_object_concentration_ok,
                 tolua_set_cipline_tech_object_concentration_ok);
  tolua_variable(tolua_S, "enable_ret_pump",
                 tolua_get_cipline_tech_object_enable_ret_pump,
                 tolua_set_cipline_tech_object_enable_ret_pump);
  tolua_variable(tolua_S, "clean_water_rinsing_return",
                 tolua_get_cipline_tech_object_clean_water_rinsing_return,
                 tolua_set_cipline_tech_object_clean_water_rinsing_return);
  tolua_variable(tolua_S, "scoldvalves",
                 tolua_get_cipline_tech_object_scoldvalves,
                 tolua_set_cipline_tech_object_scoldvalves);
  tolua_variable(tolua_S, "no_acid_wash_max",
                 tolua_get_cipline_tech_object_no_acid_wash_max,
                 tolua_set_cipline_tech_object_no_acid_wash_max);
  tolua_variable(tolua_S, "use_internal_medium_recipes",
                 tolua_get_cipline_tech_object_use_internal_medium_recipes,
                 tolua_set_cipline_tech_object_use_internal_medium_recipes);
  tolua_variable(tolua_S, "disable_final_rinsing",
                 tolua_get_cipline_tech_object_disable_final_rinsing,
                 tolua_set_cipline_tech_object_disable_final_rinsing);
  tolua_variable(tolua_S, "use_circulation_on_v2_supply",
                 tolua_get_cipline_tech_object_use_circulation_on_v2_supply,
                 tolua_set_cipline_tech_object_use_circulation_on_v2_supply);
  tolua_variable(tolua_S, "V00", tolua_get_cipline_tech_object_V00_ptr,
                 tolua_set_cipline_tech_object_V00_ptr);
  tolua_variable(tolua_S, "V01", tolua_get_cipline_tech_object_V01_ptr,
                 tolua_set_cipline_tech_object_V01_ptr);
  tolua_variable(tolua_S, "V02", tolua_get_cipline_tech_object_V02_ptr,
                 tolua_set_cipline_tech_object_V02_ptr);
  tolua_variable(tolua_S, "V03", tolua_get_cipline_tech_object_V03_ptr,
                 tolua_set_cipline_tech_object_V03_ptr);
  tolua_variable(tolua_S, "V04", tolua_get_cipline_tech_object_V04_ptr,
                 tolua_set_cipline_tech_object_V04_ptr);
  tolua_variable(tolua_S, "V05", tolua_get_cipline_tech_object_V05_ptr,
                 tolua_set_cipline_tech_object_V05_ptr);
  tolua_variable(tolua_S, "V06", tolua_get_cipline_tech_object_V06_ptr,
                 tolua_set_cipline_tech_object_V06_ptr);
  tolua_variable(tolua_S, "V07", tolua_get_cipline_tech_object_V07_ptr,
                 tolua_set_cipline_tech_object_V07_ptr);
  tolua_variable(tolua_S, "V08", tolua_get_cipline_tech_object_V08_ptr,
                 tolua_set_cipline_tech_object_V08_ptr);
  tolua_variable(tolua_S, "V09", tolua_get_cipline_tech_object_V09_ptr,
                 tolua_set_cipline_tech_object_V09_ptr);
  tolua_variable(tolua_S, "V10", tolua_get_cipline_tech_object_V10_ptr,
                 tolua_set_cipline_tech_object_V10_ptr);
  tolua_variable(tolua_S, "V11", tolua_get_cipline_tech_object_V11_ptr,
                 tolua_set_cipline_tech_object_V11_ptr);
  tolua_variable(tolua_S, "V12", tolua_get_cipline_tech_object_V12_ptr,
                 tolua_set_cipline_tech_object_V12_ptr);
  tolua_variable(tolua_S, "V13", tolua_get_cipline_tech_object_V13_ptr,
                 tolua_set_cipline_tech_object_V13_ptr);
  tolua_variable(tolua_S, "NP", tolua_get_cipline_tech_object_NP_ptr,
                 tolua_set_cipline_tech_object_NP_ptr);
  tolua_variable(tolua_S, "NK", tolua_get_cipline_tech_object_NK_ptr,
                 tolua_set_cipline_tech_object_NK_ptr);
  tolua_variable(tolua_S, "NS", tolua_get_cipline_tech_object_NS_ptr,
                 tolua_set_cipline_tech_object_NS_ptr);
  tolua_variable(tolua_S, "LL", tolua_get_cipline_tech_object_LL_ptr,
                 tolua_set_cipline_tech_object_LL_ptr);
  tolua_variable(tolua_S, "LM", tolua_get_cipline_tech_object_LM_ptr,
                 tolua_set_cipline_tech_object_LM_ptr);
  tolua_variable(tolua_S, "LH", tolua_get_cipline_tech_object_LH_ptr,
                 tolua_set_cipline_tech_object_LH_ptr);
  tolua_variable(tolua_S, "LWL", tolua_get_cipline_tech_object_LWL_ptr,
                 tolua_set_cipline_tech_object_LWL_ptr);
  tolua_variable(tolua_S, "LWH", tolua_get_cipline_tech_object_LWH_ptr,
                 tolua_set_cipline_tech_object_LWH_ptr);
  tolua_variable(tolua_S, "LSL", tolua_get_cipline_tech_object_LSL_ptr,
                 tolua_set_cipline_tech_object_LSL_ptr);
  tolua_variable(tolua_S, "LSH", tolua_get_cipline_tech_object_LSH_ptr,
                 tolua_set_cipline_tech_object_LSH_ptr);
  tolua_variable(tolua_S, "LKL", tolua_get_cipline_tech_object_LKL_ptr,
                 tolua_set_cipline_tech_object_LKL_ptr);
  tolua_variable(tolua_S, "LKH", tolua_get_cipline_tech_object_LKH_ptr,
                 tolua_set_cipline_tech_object_LKH_ptr);
  tolua_variable(tolua_S, "TP", tolua_get_cipline_tech_object_TP_ptr,
                 tolua_set_cipline_tech_object_TP_ptr);
  tolua_variable(tolua_S, "TR", tolua_get_cipline_tech_object_TR_ptr,
                 tolua_set_cipline_tech_object_TR_ptr);
  tolua_variable(tolua_S, "Q", tolua_get_cipline_tech_object_Q_ptr,
                 tolua_set_cipline_tech_object_Q_ptr);
  tolua_variable(tolua_S, "ao", tolua_get_cipline_tech_object_ao_ptr,
                 tolua_set_cipline_tech_object_ao_ptr);
  tolua_variable(tolua_S, "PUMPFREQ",
                 tolua_get_cipline_tech_object_PUMPFREQ_ptr,
                 tolua_set_cipline_tech_object_PUMPFREQ_ptr);
  tolua_variable(tolua_S, "FL", tolua_get_cipline_tech_object_FL_ptr,
                 tolua_set_cipline_tech_object_FL_ptr);
  tolua_variable(tolua_S, "cnt", tolua_get_cipline_tech_object_cnt_ptr,
                 tolua_set_cipline_tech_object_cnt_ptr);
  tolua_array(tolua_S, "T", tolua_get_PAC_dev_cipline_tech_object_T,
              tolua_set_PAC_dev_cipline_tech_object_T);
  tolua_variable(tolua_S, "PIDP", tolua_get_cipline_tech_object_PIDP_ptr,
                 tolua_set_cipline_tech_object_PIDP_ptr);
  tolua_variable(tolua_S, "PIDF", tolua_get_cipline_tech_object_PIDF_ptr,
                 tolua_set_cipline_tech_object_PIDF_ptr);
  tolua_variable(tolua_S, "msa_number",
                 tolua_get_cipline_tech_object_msa_number,
                 tolua_set_cipline_tech_object_msa_number);
  tolua_variable(tolua_S, "ncar1", tolua_get_cipline_tech_object_ncar1,
                 tolua_set_cipline_tech_object_ncar1);
  tolua_variable(tolua_S, "ncar2", tolua_get_cipline_tech_object_ncar2,
                 tolua_set_cipline_tech_object_ncar2);
  tolua_variable(tolua_S, "ncar3", tolua_get_cipline_tech_object_ncar3,
                 tolua_set_cipline_tech_object_ncar3);
  tolua_variable(tolua_S, "ncar4", tolua_get_cipline_tech_object_ncar4,
                 tolua_set_cipline_tech_object_ncar4);
  tolua_variable(tolua_S, "switch1", tolua_get_cipline_tech_object_switch1,
                 tolua_set_cipline_tech_object_switch1);
  tolua_variable(tolua_S, "switch2", tolua_get_cipline_tech_object_switch2,
                 tolua_set_cipline_tech_object_switch2);
  tolua_variable(tolua_S, "switch3", tolua_get_cipline_tech_object_switch3,
                 tolua_set_cipline_tech_object_switch3);
  tolua_variable(tolua_S, "switch4", tolua_get_cipline_tech_object_switch4,
                 tolua_set_cipline_tech_object_switch4);
  tolua_variable(tolua_S, "par_float", tolua_get_cipline_tech_object_par_float,
                 tolua_set_cipline_tech_object_par_float);
  tolua_variable(tolua_S, "rt_par_float",
                 tolua_get_cipline_tech_object_rt_par_float,
                 tolua_set_cipline_tech_object_rt_par_float);
  tolua_function(tolua_S, "get_station_par",
                 tolua_PAC_dev_cipline_tech_object_get_station_par00);
  tolua_function(tolua_S, "set_station_par",
                 tolua_PAC_dev_cipline_tech_object_set_station_par00);
  tolua_function(tolua_S, "get_selfclean_par",
                 tolua_PAC_dev_cipline_tech_object_get_selfclean_par00);
  tolua_function(tolua_S, "set_selfclean_par",
                 tolua_PAC_dev_cipline_tech_object_set_selfclean_par00);
  tolua_function(tolua_S, "set_cmd",
                 tolua_PAC_dev_cipline_tech_object_set_cmd00);
  tolua_function(tolua_S, "set_cmd",
                 tolua_PAC_dev_cipline_tech_object_set_cmd01);
  tolua_function(tolua_S, "initline",
                 tolua_PAC_dev_cipline_tech_object_initline00);
  tolua_function(tolua_S, "evaluate",
                 tolua_PAC_dev_cipline_tech_object_evaluate00);
  tolua_function(tolua_S, "GetConc",
                 tolua_PAC_dev_cipline_tech_object_GetConc00);
  ...
  tolua_function(tolua_S, "ForceRet",
                 tolua_PAC_dev_cipline_tech_object_ForceRet00);
  tolua_function(tolua_S, "GetRetState",
                 tolua_PAC_dev_cipline_tech_object_GetRetState00);
  tolua_function(tolua_S, "HasRet", tolua_PAC_dev_cipline_tech_object_HasRet00);
  tolua_function(tolua_S, "timeIsOut",
                 tolua_PAC_dev_cipline_tech_object_timeIsOut00);
  tolua_function(tolua_S, "_DoStep",
                 tolua_PAC_dev_cipline_tech_object__DoStep00);
  tolua_function(tolua_S, "_GoToStep",
                 tolua_PAC_dev_cipline_tech_object__GoToStep00);
  tolua_function(tolua_S, "_InitStep",
                 tolua_PAC_dev_cipline_tech_object__InitStep00);
  tolua_function(tolua_S, "_LoadProgram",
                 tolua_PAC_dev_cipline_tech_object__LoadProgram00);
  tolua_function(tolua_S, "_StopDev",
                 tolua_PAC_dev_cipline_tech_object__StopDev00);
  tolua_function(
      tolua_S, "_ResetLinesDevicesBeforeReset",
      tolua_PAC_dev_cipline_tech_object__ResetLinesDevicesBeforeReset00);
  tolua_function(tolua_S, "_OporCIP",
                 tolua_PAC_dev_cipline_tech_object__OporCIP00);
  tolua_function(tolua_S, "_InitOporCIP",
                 tolua_PAC_dev_cipline_tech_object__InitOporCIP00);
  tolua_function(tolua_S, "_CheckErr",
                 tolua_PAC_dev_cipline_tech_object__CheckErr00);
  tolua_function(tolua_S, "_Circ", tolua_PAC_dev_cipline_tech_object__Circ00);
  tolua_function(tolua_S, "_InitCirc",
                 tolua_PAC_dev_cipline_tech_object__InitCirc00);
  tolua_function(tolua_S, "_InitToObject",
                 tolua_PAC_dev_cipline_tech_object__InitToObject00);
  tolua_function(tolua_S, "_InitFromObject",
                 tolua_PAC_dev_cipline_tech_object__InitFromObject00);
  tolua_function(tolua_S, "_InitFilCirc",
                 tolua_PAC_dev_cipline_tech_object__InitFilCirc00);
  tolua_function(tolua_S, "_InitOporCirc",
                 tolua_PAC_dev_cipline_tech_object__InitOporCirc00);
  tolua_function(tolua_S, "_ToObject",
                 tolua_PAC_dev_cipline_tech_object__ToObject00);
  tolua_function(tolua_S, "_FromObject",
                 tolua_PAC_dev_cipline_tech_object__FromObject00);
  tolua_function(tolua_S, "_FillCirc",
                 tolua_PAC_dev_cipline_tech_object__FillCirc00);
  tolua_function(tolua_S, "_OporCirc",
                 tolua_PAC_dev_cipline_tech_object__OporCirc00);
  ...
  tolua_function(tolua_S, "_InitDoseRR",
                 tolua_PAC_dev_cipline_tech_object__InitDoseRR00);
  tolua_function(tolua_S, "_DoseRR",
                 tolua_PAC_dev_cipline_tech_object__DoseRR00);
  tolua_endmodule(tolua_S);
#ifdef __cplusplus
  tolua_cclass(tolua_S, "modbus_client", "modbus_client", "",
               tolua_collect_modbus_client);
#else
  ...
  tolua_function(tolua_S, "read_discrete_inputs",
                 tolua_PAC_dev_modbus_client_read_discrete_inputs00);
  tolua_function(tolua_S, "read_coils",
                 tolua_PAC_dev_modbus_client_read_coils00);
  tolua_function(tolua_S, "read_holding_registers",
                 tolua_PAC_dev_modbus_client_read_holding_registers00);
  tolua_function(tolua_S, "read_input_registers",
                 tolua_PAC_dev_modbus_client_read_input_registers00);
  tolua_function(tolua_S, "write_coil",
                 tolua_PAC_dev_modbus_client_write_coil00);
  tolua_function(tolua_S, "force_multiply_coils",
                 tolua_PAC_dev_modbus_client_force_multiply_coils00);
  tolua_function(tolua_S, "write_multiply_registers",
                 tolua_PAC_dev_modbus_client_write_multiply_registers00);
  tolua_function(tolua_S, "async_read_discrete_inputs",
                 tolua_PAC_dev_modbus_client_async_read_discrete_inputs00);
  tolua_function(tolua_S, "async_read_coils",
                 tolua_PAC_dev_modbus_client_async_read_coils00);
  tolua_function(tolua_S, "async_read_holding_registers",
                 tolua_PAC_dev_modbus_client_async_read_holding_registers00);
  tolua_function(tolua_S, "async_read_input_registers",
                 tolua_PAC_dev_modbus_client_async_read_input_registers00);
  tolua_function(tolua_S, "async_write_coil",
                 tolua_PAC_dev_modbus_client_async_write_coil00);
  tolua_function(tolua_S, "async_force_multiply_coils",
                 tolua_PAC_dev_modbus_client_async_force_multiply_coils00);
  tolua_function(tolua_S, "async_write_multiply_registers",
                 tolua_PAC_dev_modbus_client_async_write_multiply_registers00);
  tolua_function(
      tolua_S, "async_read_write_multiply_registers",
      tolua_PAC_dev_modbus_client_async_read_write_multiply_registers00);
  tolua_function(tolua_S, "async_mask_write_register",
                 tolua_PAC_dev_modbus_client_async_mask_write_register00);
  tolua_function(tolua_S, "async_mask_write_register",
                 tolua_PAC_dev_modbus_client_async_mask_write_register01);
  tolua_function(tolua_S, "get_async_result",
                 tolua_PAC_dev_modbus_client_get_async_result00);
  tolua_function(tolua_S, "set_station",
                 tolua_PAC_dev_modbus_client_set_station00);
  tolua_function(tolua_S, "zero_output_buff",
                 tolua_PAC_dev_modbus_client_zero_output_buff00);
  ...
  tolua_function(tolua_S, "reg_get_bit",
                 tolua_PAC_dev_modbus_client_reg_get_bit00);
  tolua_function(tolua_S, "reg_set_bit",
                 tolua_PAC_dev_modbus_client_reg_set_bit00);
  tolua_function(tolua_S, "mask_reset",
                 tolua_PAC_dev_modbus_client_mask_reset00);
  tolua_function(tolua_S, "mask_set_bit",
                 tolua_PAC_dev_modbus_client_mask_set_bit00);
  ...
  tolua_function(tolua_S, "UnpackInt16",
                 tolua_PAC_dev_ModbusServ_UnpackInt1600);
  tolua_function(tolua_S, "UnpackInt32",
                 tolua_PAC_dev_ModbusServ_UnpackInt3200);
  tolua_function(tolua_S, "UnpackFloat",
                 tolua_PAC_dev_ModbusServ_UnpackFloat00);
  ...
  tolua_function(tolua_S, "set_station_address",
                 tolua_PAC_dev_profibus_slave_set_station_address00);
  tolua_function(tolua_S, "set_output_byte_size",
                 tolua_PAC_dev_profibus_slave_set_output_byte_size00);
  tolua_function(tolua_S, "set_input_byte_size",
                 tolua_PAC_dev_profibus_slave_set_input_byte_size00);
  tolua_function(tolua_S, "get_double",
                 tolua_PAC_dev_profibus_slave_get_double00);
  ...
  tolua_endmodule(tolua_S);
  tolua_function(tolua_S, "G_PROFIBUS_SLAVE_LUA",
                 tolua_PAC_dev_G_PROFIBUS_SLAVE_LUA00);
