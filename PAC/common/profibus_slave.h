...
class profibus_slave {
 ...
 public:
  ...
  /// </summary>
  void set_station_address(int address) { station_address = address; }

  /// <summary>
  /// Установка размера массива области записи.
  /// </summary>
  void set_output_byte_size(int size) { output_byte_size = size; }

  /// <summary>
  /// Установка размера массива области чтения.
  /// </summary>
  void set_input_byte_size(int size) { input_byte_size = size; }
