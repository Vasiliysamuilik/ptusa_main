...
{ CS_None = 0,
  ...
  CS_Singapore_Low,
  CS_Last } tCommunicationStandard;
...
{ EPCSW_Mode0 = 0,
  EPCSW_Mode1,
  EPCSW_Last } tETSIPortChannelSwitchingMode;
...
{ MT_DSB = 0,  // Zweiseitenbandmodulation
  ...
  MT_EXT,      // R1000-externe Zweiseitenbandmodulation (momentan nicht
               // unterstützt)
  MT_Last } tModulationType;
...
{ CGF_Going = 0x00,
  ...
  CGF_Coming = 0xFF } tComingGoingFlag;
...
{ SSHBF_Stop = 0x00,
  ...
  SSHBF_Start = 0xFF } tStartStopHeartbeatFlag;
...
{ RLBCF_Start = 0,
  RLBCF_Do,
  RLBCF_Stop,
  RLBCF_Last } tRSSILedBarControlFlag;
...
{ EMID_Error_NoFreeChannel = 0,
  ...
  EMID_Error_Last } tErrorMessageId;
...
#endif
{ IM_Last = 0,
  IM_StartUserMessages = 0xC0 } tInfoMessage;
...
{ TEC_NoError = 0x00,
  ...
  TEC_NonSpecific = 0x8F } tTagErrorCode;
...
#endif
{ IOCS_NotSpecified = 0,
  IOCS_KBP,       // *** veraltet, wird ab Firmwareversion 1.50.00 nicht mehr
                  // unterstützt ***
  IOCS_STDPRTCL,  // *** veraltet, wird ab Firmwareversion 1.50.00 nicht mehr
                  // unterstützt ***
  IOCS_KBRP,      // Kathrein Burgstädt Reader Protokoll (KBRP)
  IOCS_KBRPNHS,   // Kathrein Burgstädt Reader Protokoll (KBRP) ohne Handshake
  IOCS_KBRPETH,   // Kathrein Burgstädt Reader Protokoll (KBRP) für
                  // Ethernetverbindungen
  IOCS_Last } tIOCardService;
...
{ GPIOOF_Off = 0,
  ...
  GPIOOF_Last } tGPIOOutputFunction;
