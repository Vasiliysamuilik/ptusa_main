...
TEST(device_manager, add_io_device) {
  ...
  res = G_DEVICE_MANAGER()->add_io_device(device::DT_GS, device::DST_GS,
                                          name.c_str(), "Test GS", "Firma 1");
  EXPECT_NE(nullptr, res);
  ...
  name = std::string("GS2");
  res = G_DEVICE_MANAGER()->add_io_device(device::DT_GS, device::DST_GS_VIRT,
                                          name.c_str(), "Test GS", "Firma 1");
  ...
  // device::DST_GS, device::DST_GS_INVERSE
  name = std::string("GS3");
  res = G_DEVICE_MANAGER()->add_io_device(device::DT_GS, device::DST_GS_INVERSE,
                                          name.c_str(), "Test GS", "Firma 1");
  EXPECT_NE(nullptr, res);
  dev = G_DEVICE_MANAGER()->get_device(name.c_str());
  EXPECT_NE(G_DEVICE_MANAGER()->get_stub_device(), dev);
  ...
  name = std::string("V3");
  res = G_DEVICE_MANAGER()->add_io_device(device::DT_V,
                                          device::DST_V_MINI_FLUSHING,
                                          name.c_str(), "Test valve", "Test");
  EXPECT_NE(nullptr, res);
  dev = G_DEVICE_MANAGER()->get_device(name.c_str());
  EXPECT_NE(G_DEVICE_MANAGER()->get_stub_device(), dev);
  Vx = V(name.c_str());
  ...
  name = std::string("V4");
  res =
      G_DEVICE_MANAGER()->add_io_device(device::DT_V, device::V_IOLINK_VTUG_DO1,
                                        name.c_str(), "Test valve", "Test");
  EXPECT_NE(nullptr, res);
  dev = G_DEVICE_MANAGER()->get_device(name.c_str());
  EXPECT_NE(G_DEVICE_MANAGER()->get_stub_device(), dev);
  ...
  name = std::string("V9");
  res = G_DEVICE_MANAGER()->add_io_device(
      device::DT_V, device::V_IOL_TERMINAL_MIXPROOF_DO3_DI2, name.c_str(),
      "Test valve", "Test");
  EXPECT_NE(nullptr, res);
  dev = G_DEVICE_MANAGER()->get_device(name.c_str());
  EXPECT_NE(G_DEVICE_MANAGER()->get_stub_device(), dev);
  ...
  Vx = V(name.c_str());
  EXPECT_NE(STUB(), dynamic_cast<dev_stub*>(Vx));
  EXPECT_EQ(dynamic_cast<valve_AS_mix_proof*>(Vx)->reverse_seat_connection,
            true);

  // device::DT_V, device::DST_V_AS_MIXPROOF, AlfaLaval old mixproof
  name = std::string("V92");
  res =
      G_DEVICE_MANAGER()->add_io_device(device::DT_V, device::DST_V_AS_MIXPROOF,
                                        name.c_str(), "Test valve", "Test");
  EXPECT_NE(nullptr, res);
  dev = G_DEVICE_MANAGER()->get_device(name.c_str());
  EXPECT_NE(G_DEVICE_MANAGER()->get_stub_device(), dev);
  ...
  res =
      G_DEVICE_MANAGER()->add_io_device(device::DT_FQT, device::DST_FQT_IOLINK,
                                        name.c_str(), "Test counter", "IFM");
  EXPECT_NE(nullptr, res);
  dev = G_DEVICE_MANAGER()->get_device(name.c_str());
  EXPECT_NE(G_DEVICE_MANAGER()->get_stub_device(), dev);
  ...
  res = G_DEVICE_MANAGER()->add_io_device(device::DT_FQT, device::DST_FQT,
                                          name.c_str(), "Test counter", "IFM");
  EXPECT_NE(nullptr, res);
  dev = G_DEVICE_MANAGER()->get_device(name.c_str());
  EXPECT_NE(G_DEVICE_MANAGER()->get_stub_device(), dev);
  ...
  res = G_DEVICE_MANAGER()->add_io_device(device::DT_FQT, device::DST_FQT_F,
                                          name.c_str(), "Test counter", "IFM");
  EXPECT_NE(nullptr, res);
  dev = G_DEVICE_MANAGER()->get_device(name.c_str());
  EXPECT_NE(G_DEVICE_MANAGER()->get_stub_device(), dev);
  ...
  res = G_DEVICE_MANAGER()->add_io_device(device::DT_PDS, device::DST_PDS,
                                          name.c_str(), "Test sensor", "CR");
  EXPECT_NE(nullptr, res);
  dev = G_DEVICE_MANAGER()->get_device(name.c_str());
  EXPECT_NE(G_DEVICE_MANAGER()->get_stub_device(), dev);
  ...
  res = G_DEVICE_MANAGER()->add_io_device(device::DT_PDS, device::DST_PDS_VIRT,
                                          name.c_str(), "Test sensor", "CR");
  EXPECT_EQ(nullptr, res);
  dev = G_DEVICE_MANAGER()->get_device(name.c_str());
  EXPECT_NE(G_DEVICE_MANAGER()->get_stub_device(), dev);
  ...
  res = G_DEVICE_MANAGER()->add_io_device(device::DT_PDS,
                                          device::DST_PDS_VIRT + 1,
                                          name.c_str(), "Test sensor", "CR");
  EXPECT_EQ(nullptr, res);

  // device::DT_TS, device::DST_TS
  name = std::string("TS1");
  res = G_DEVICE_MANAGER()->add_io_device(device::DT_TS, device::DST_TS,
                                          name.c_str(), "Test sensor", "CR");
  EXPECT_NE(nullptr, res);
  dev = G_DEVICE_MANAGER()->get_device(name.c_str());
  EXPECT_NE(G_DEVICE_MANAGER()->get_stub_device(), dev);
  ...
  name = std::string("TS2");
  res = G_DEVICE_MANAGER()->add_io_device(device::DT_TS, device::DST_TS_VIRT,
                                          name.c_str(), "Test sensor", "CR");
  EXPECT_EQ(nullptr, res);
  dev = G_DEVICE_MANAGER()->get_device(name.c_str());
  EXPECT_NE(G_DEVICE_MANAGER()->get_stub_device(), dev);
  ...
  name = std::string("TS3");
  res =
      G_DEVICE_MANAGER()->add_io_device(device::DT_TS, device::DST_TS_VIRT + 1,
                                        name.c_str(), "Test sensor", "CR");
  EXPECT_EQ(nullptr, res);

  // device::DT_WT, DST_WT_RS232
  name = std::string("WT1");
  res = G_DEVICE_MANAGER()->add_io_device(device::DT_WT, device::DST_WT_RS232,
                                          name.c_str(), "Test scales", "W");
  EXPECT_NE(nullptr, res);
  dev = G_DEVICE_MANAGER()->get_device(name.c_str());
  EXPECT_NE(G_DEVICE_MANAGER()->get_stub_device(), dev);
  ...
  name = std::string("C1");
  res = G_DEVICE_MANAGER()->add_io_device(device::DT_REGULATOR,
                                          device::DST_REGULATOR_PID,
                                          name.c_str(), "Test PID", "C");
  EXPECT_EQ(nullptr, res);
  dev = G_DEVICE_MANAGER()->get_device(name.c_str());
  EXPECT_NE(G_DEVICE_MANAGER()->get_stub_device(), dev);
  ...
  name = std::string("C2");
  res = G_DEVICE_MANAGER()->add_io_device(device::DT_REGULATOR,
                                          device::DST_REGULATOR_THLD,
                                          name.c_str(), "Test regulator", "C");
  EXPECT_EQ(nullptr, res);
  dev = G_DEVICE_MANAGER()->get_device(name.c_str());
  EXPECT_NE(G_DEVICE_MANAGER()->get_stub_device(), dev);
  ...
  name = std::string("W1");
  res = G_DEVICE_MANAGER()->add_io_device(device::DT_WT, device::DST_WT_ETH,
                                          name.c_str(), "Test wages", "W");
  EXPECT_NE(nullptr, res);
  dev = G_DEVICE_MANAGER()->get_device(name.c_str());
  EXPECT_NE(G_DEVICE_MANAGER()->get_stub_device(), dev);
  ...
  name = std::string("W2");
  res = G_DEVICE_MANAGER()->add_io_device(device::DT_WT, device::DST_WT_PXC_AXL,
                                          name.c_str(), "Test wages", "W");
  EXPECT_NE(nullptr, res);
  dev = G_DEVICE_MANAGER()->get_device(name.c_str());
  EXPECT_NE(G_DEVICE_MANAGER()->get_stub_device(), dev);
  ...
  name = std::string("G1");
  res = G_DEVICE_MANAGER()->add_io_device(device::DT_G, device::DST_G_IOL_4,
                                          name.c_str(), "Test power unit", "G");
  EXPECT_NE(nullptr, res);
  dev = G_DEVICE_MANAGER()->get_device(name.c_str());
  EXPECT_NE(G_DEVICE_MANAGER()->get_stub_device(), dev);
  ...
  res = G_DEVICE_MANAGER()->add_io_device(device::DT_G, device::DST_G_IOL_8 + 1,
                                          name.c_str(), "Test power unit", "G");
  EXPECT_EQ(nullptr, res);
}
...
TEST(dev_stub, get_pump_dt) { EXPECT_EQ(.0f, STUB()->get_pump_dt()); }

TEST(dev_stub, get_min_flow) { EXPECT_EQ(.0f, STUB()->get_min_flow()); }
...
TEST(valve_iol_terminal_DO1_DI1_off, get_fb_state) {
  ...
  V1.set_rt_par(static_cast<u_int>(valve_iol_terminal::TERMINAL_OUTPUT::ON), 2);
...
TEST(valve_iol_terminal_mixproof_DO3, off) {
  ...
  V1.AO_channels.int_write_values[1] = new int_2[2]{0};
  V1.AO_channels.int_write_values[2] = new int_2[2]{0};
  V1.set_rt_par(static_cast<u_int>(valve_iol_terminal::TERMINAL_OUTPUT::ON), 1);
  V1.set_rt_par(
...
TEST(valve_iol_terminal_mixproof_DO3_DI2, get_fb_state) {
  ...
  V1.save_device(buff, "");
  EXPECT_STREQ(
      "V1={M=0, ST=0, FB_ON_ST=1, FB_OFF_ST=1, P_ON_TIME=0, P_FB=0},\n", buff);
...
TEST(counter_iolink, get_quantity) {
  class counter_iolink_test : public counter_iolink {
   ...
   public:
    counter_iolink_test(const char* dev_name) : counter_iolink(dev_name){};

    float get_raw_value() const { return totalizer; };

    void set_raw_value(float totalizer) { this->totalizer = totalizer; };
  };
...
TEST(wages_eth, direct_set_tcp_buff) {
  ...
  const auto NOT_VALID_DATA = {"          ", "+00000.5kt", "+00000.5zg",
                               "+00000.5zt"};
...
TEST(temperature_e, save_device) {
  ...
  T1.set_cmd("E", 0, 1);
  T1.save_device(buff, "");
  EXPECT_STRNE("T1={M=0, ST=1, V=0, E=1, P_CZ=0, P_ERR_T=0},\n", buff);
}
...
TEST(threshold_regulator, set_value) {
  ...
  res = G_DEVICE_MANAGER()->add_io_device(device::DT_M, device::DST_M_VIRT,
                                          M_name.c_str(), "Test motor", "M");
  ASSERT_EQ(nullptr, res);
  ...
  res = G_DEVICE_MANAGER()->add_io_device(device::DT_FQT, device::DST_FQT_VIRT,
                                          name.c_str(), "Test counter", "F");
  ASSERT_EQ(nullptr, res);
...
TEST(threshold_regulator, set_cmd) {
  ...
  p1.save_device(buff);
  EXPECT_STREQ("\tC1={M=0, ST=0, V=0, P_is_reverse=0, P_delta=0},\n", buff);
  ...
  p1.on();
  p1.save_device(buff);
  EXPECT_STREQ("\tC1={M=0, ST=1, V=0, P_is_reverse=1, P_delta=10},\n", buff);
}
